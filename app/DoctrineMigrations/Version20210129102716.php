 ...
 */
final class Version20210129102716 extends AbstractMigration
{
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('CREATE TABLE s_organization_years (id INT AUTO_INCREMENT NOT NULL, organization_code INT NOT NULL, year INT NOT NULL, INDEX IDX_38FF0D6E4E1C0E05 (organization_code), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
