...
class Version20200921073603 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE s_companies (id INT AUTO_INCREMENT NOT NULL, region_id INT NOT NULL, name VARCHAR(512) NOT NULL, legal_address VARCHAR(512) DEFAULT NULL, director VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_2015E64F98260155 (region_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
