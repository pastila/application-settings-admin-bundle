 ...
 */
final class Version20210128144109 extends AbstractMigration
{
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('CREATE TABLE s_organization_years (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, year INT NOT NULL, year_key INT NOT NULL, INDEX IDX_38FF0D6E32C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
