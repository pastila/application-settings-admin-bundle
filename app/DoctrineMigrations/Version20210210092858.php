...
final class Version20210210092858 extends AbstractMigration
{
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE s_users ADD bitrix_id INT DEFAULT NULL, DROP username, DROP username_canonical, DROP email_canonical, DROP enabled, DROP password, DROP last_login, DROP confirmation_token, DROP password_requested_at, DROP roles, DROP phone, DROP birth_date, DROP insurance_policy_number, DROP terms_and_conditions_accepted, DROP salt, CHANGE email email VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE first_name first_name VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE last_name last_name VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE middle_name middle_name VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`');
  }
}
