 ...
 */
final class Version20210128065618 extends AbstractMigration
{
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('CREATE TABLE s_organizations (code INT NOT NULL, region_id INT NOT NULL, name VARCHAR(255) NOT NULL, name_full VARCHAR(512) DEFAULT NULL, address VARCHAR(512) DEFAULT NULL, published TINYINT(1) DEFAULT \'1\' NOT NULL, INDEX IDX_FC6596A498260155 (region_id), PRIMARY KEY(code)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
    $this->addSql('CREATE TABLE s_organization_chief_medical_officers (id INT AUTO_INCREMENT NOT NULL, organization_id INT DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, first_name VARCHAR(255) DEFAULT NULL, middle_name VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8F4D31BA32C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
    ...
    $this->addSql('ALTER TABLE s_organization_years ADD CONSTRAINT FK_38FF0D6E32C8A3DE FOREIGN KEY (organization_id) REFERENCES s_organizations (code) ON DELETE RESTRICT');
  }
