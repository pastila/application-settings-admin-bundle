...
class Version20200921160913 extends AbstractMigration
{
  ...
  public function up(Schema $schema)
  {
    ...
    $this->addSql('CREATE TABLE s_company_branches (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, region_id INT DEFAULT NULL, name VARCHAR(512) NOT NULL, legal_address VARCHAR(512) DEFAULT NULL, code VARCHAR(256) DEFAULT NULL, INDEX IDX_EB2CC66C979B1AD6 (company_id), INDEX IDX_EB2CC66C98260155 (region_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    $this->addSql('ALTER TABLE s_companies DROP region_id, DROP legal_address, DROP director');
  ...
  public function down(Schema $schema)
  {
    ...
    $this->addSql('ALTER TABLE s_companies ADD region_id INT NOT NULL, ADD legal_address VARCHAR(512) DEFAULT NULL COLLATE utf8_unicode_ci, ADD director VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
