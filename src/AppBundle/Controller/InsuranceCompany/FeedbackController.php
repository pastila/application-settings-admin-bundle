...
use AppBundle\Entity\Company\CompanyFeedback;
...
//
    ...
    $fb1 = new Feedback();
    $fb1->setHead('Мне помогли с лечением зуба даже без полиса');
    ...
    $fb2 = new Feedback();
    $fb2->setHead('Мне помогли с лечением зуба даже без полиса');
    ...
    $fb3 = new Feedback();
    $fb3->setHead('Мне помогли с лечением зуба даже без полиса');
