...
<div class="feedback">
    <div class="feedback__wrap_white-blocks">
        ...
        $arFields = $ob->GetFields();
            DateTime::createFromFormat('H\h i\m s\s',$arFields["DATE_ACTIVE_FROM"])->format('H:i:s');
        ...
        <div class="white_block">
            ...
            <div class="feedback__block_top">
                ...
                <div class="feedback__block_top_name">
                    <?=$name_user?>, <?=$arProps["REGION"]['VALUE']?>, <?=$arFields["DATE_ACTIVE_FROM"]?>
                </div>
