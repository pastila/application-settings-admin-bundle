            ...
            <div class="obrashcheniya__content_left">
                ...
                <div class="obrashcheniya__content_left_center">
                    ...
                    <div class="obrashcheniya__content_left_center_item">
                        ...
                        <p id="phone_<?= $arItem['ID'] ?>" class="obrashcheniya__content_left_center__item_text-full">
                    ...
                    <div class="obrashcheniya__content_left_center_item">
                        ...
                        <p id="hospitl_<?= $arItem['ID'] ?>" class="obrashcheniya__content_left_center_item_text-full">
                            <?php echo $hospital ?></p>
                    </div>
                ...
                <div class="input-with-search">
                    ...
                    <div class="input__wrap">
                        ...
                        <input id="children_input_<?=$arItem['ID']?>" class="children_input"
                            data-value="<?=$arItem['ID']?>" data-id_child="" name="region_input" type="text"
...
<div class="obrashcheniya">
    <p> У вас нет готовых обращений. Сформировать обращение на возврат средств за медицинскую помощь по программе ОМС
        можно
