            ...
            if ($arResult['SECTION']['DEPTH_LEVEL'] == 1) {
                ...
                <div class="input-with-search">
                    ...
                    <div class="input__wrap">
                        ...
                        <input id="region_input_<?=$arParams['ID_ELEM']?>" type="text" data-id_region="<?=$arResult['SECTION']['ID']?>" placeholder="Поиск по региону" value="<?php echo $arResult['SECTION']['NAME']?>" autocomplete="off"/>
                        <ul style="cursor: pointer;" class="custom-serach__items" id="search_result_region_<?=$arParams['ID_ELEM']?>">
                <?php
                ...
                while ($ar_result = $db_list->GetNext()) { ?>
                    <li value="<?=$ar_result['ID']?>" class="custom-serach__items_item region-js_<?=$arParams['ID_ELEM']?>"><?php echo $ar_result['NAME']?></li>
                <?php }?>
                        </ul>
                    </div>
                </div>
                ...
                <div class="input-with-search">
                    ...
                    <div class="input__wrap">
                        ...
                        <?php if (empty($arParams['ID_ELEM'])) { ?>
                            <input id="hospital_input_<?=$arParams['ID_ELEM']?>" data-id_hospital="" type="text"
        ...
        <?php } else { ?>
            <div class="input-with-search">
                ...
                <div class="input__wrap">
                    ...
                    <input id="region_input_<?=$arParams['ID_ELEM']?>" name="region_input" type="text" placeholder="Поиск по региону" autocomplete="off"/>
                    <span style="display: none" class="error_search-js_<?=$arParams['ID_ELEM']?>">Выберете регион</span>
                    <ul style="cursor: pointer;" class="custom-serach__items" id="search_result_region_<?=$arParams['ID_ELEM']?>">
                        <?php
                        foreach ($arResult['SECTIONS'] as &$arSection) {?>
                            <?php if ($arSection['DEPTH_LEVEL'] == 1) { ?>
                                <li value="<?=$arSection["ID"]?>" class="custom-serach__items_item region-js_<?=$arParams['ID_ELEM']?>"><?php echo $arSection['NAME']?></li>
                            <?php }?>
                        <?php } ?>
                    </ul>
                </div>
