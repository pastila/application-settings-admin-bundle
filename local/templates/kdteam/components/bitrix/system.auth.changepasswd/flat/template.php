...
<section class="personalCabinet">
    ...
    <div class="white_block block-recovery_pass">
        ...
        <?endif?>
        <form class="form-recovery_main" method="post" action="<?=$arResult["AUTH_FORM"]?>" name="bform">
            ...
            <div class="bx-authform-formgroup-container">
                <input type="submit" class="mainBtn  main-btn_fullwidth" name="change_pwd" value="<?=GetMessage("AUTH_CHANGE")?>" />
            </div>
