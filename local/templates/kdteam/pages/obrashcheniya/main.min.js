function addChild() {
    document.querySelectorAll(".obrashcheniya__content").forEach(function(e) {
        const t = e.querySelector("#add_child-button"),
            n = e.querySelector("#remove_child-button"),
            i = e.querySelector(".hidden_child-block");
        t && (t.addEventListener("click", function(e) {
            if (this.classList.add("active"), t.classList.contains("active")) {
                i.classList.add("active");
                let e = t.getAttribute("data_el");
                $("#selected_sender_" + e).val("child"), commutator("child", e), i.scrollIntoView({
                    block: "center",
                    behavior: "smooth"
                })
            ...
            let t = n.getAttribute("data_el");
            $("#selected_sender_" + t).val("my"), commutator("my", t)
        }))
    })
}

function search(e) {
    $(document).on("click", "#searchul_" + e + " li", function() {
        $("#children_input_" + e).val($(this).text()), $("#children_input_" + e).attr("data-id_child", $(this).attr("value")), $("#searchul_" + e).fadeOut(), -1 !== $("#time_" + e).text().search(".20") && $.post("/ajax/obrasheniya/selected_child.php", {
            ID: $(this).attr("value")
        }, function(t) {
            $("#selected-child_" + e).html(t), $.ajax({
                url: "/pdf/file_children_pdf.php",
                data: {
                    id: $("#children_input_" + e).attr("data-id_child"),
                    oplata: $("#time_" + e).text(),
                    id_obr: e
                },
                type: "post",
                success: function(t) {
                    $("[data-obrashenie-id=" + e + "]").find(".pdf").attr("href", t), $("[data-obrashenie-id=" + e + "]").find(".pdf").removeClass("error"), $("[data-obrashenie-id=" + e + "]").find(".pdf").text("Просмотреть"), $(".ready_pdf").removeClass("hidden"), $(".with_out_pdf").addClass("hidden"), 0 !== $("[data-block_img=" + e + "]").find("[id*=img_block_" + e).length && "-1" != $("#time_" + e).text().search("2") && ($("#send_" + e).attr("onclick", "send_ms(this)"), $("#send_" + e).removeClass("disabled"))
                }
            })
        }, "html")
    }), $(document).mouseup(function(t) {
        0 === $("#class_input_" + e).has(t.target).length && $("#searchul_" + e).fadeOut()
    })
}
...
function del(e) {
    ...
    $.ajax({
        ...
        success: function(e) {
            let t = JSON.parse(e);
            $("#img_block_" + t.ID).remove(), history.scrollRestoration = "manual", $("#success_" + t.ID_EL).text("Файл успешно удален!"), $("#error_" + t.ID_EL).text(""), document.getElementById(t.ID_EL).value = "", history.scrollRestoration = "manual", 0 === $("[data-block_img=" + t.ID_EL + "]").find("[id*=img_block_" + t.ID_EL + "]").length && ($(".photo_empty_all_" + t.ID_EL).html("Нужно добавить скан документа/изображения для отправки обращения страховой компании"), $("#send_" + t.ID_EL).removeAttr("onclick"), $("#send_" + t.ID_EL).addClass("disabled")), history.scrollRestoration = "manual"
        }
    })
}

function delete_el(e) {
    let t = $(e)[0].id;
    $.ajax({
        ...
        success: function(e) {
            var t = JSON.parse(e);
            "" !== t.delete && ($("#appeal_" + t.delete).remove(), 1 == t.count && ($(".page-title").after('<div class="obrashcheniya"></div>'), $(".obrashcheniya").append("<p>У вас нет готовых обращений.</p>"), $(".obrashcheniya").after('<a href="/forma-obrashenija/" class="mainBtn "">Сформировать обращение</a>')))
        }
    })
}

function edit(e) {
    let t = $(e)[0].id.split("_"),
        n = $("#appeal_" + t[1]);
    $("[data-id-date_picker_edit=" + t[1] + "]").removeAttr("onclick");
    let i = $("input[name='usrname']"),
        s = $("input[name='policy']"),
        r = $("input[name='time']"),
        a = $("#usrname_" + t[1]),
        o = $("#policy_" + t[1]),
        l = $("#time_" + t[1]);
    $("#save_" + t[1]).css("display", "inline-block"), n.find(i).css("display", "block"), n.find(s).css("display", "block"), n.find(r).css("display", "block"), $("#edit_" + t[1]).css("display", "none"), a.css("display", "none"), o.css("display", "none"), l.css("display", "none")
}

function save(e) {
    let t = $(e)[0].id.split("_"),
        n = $("#appeal_" + t[1]),
        i = $("input[name='usrname']"),
        s = $("input[name='policy']"),
        r = $("input[name='time']"),
        a = $("#usrname_" + t[1]),
        o = $("#policy_" + t[1]),
        l = $("#time_" + t[1]),
        c = $("#hospitl_" + t[1]),
        d = /^[А-ЯЁ][а-яё]*([-][А-ЯЁ][а-яё]*)?\s[А-ЯЁ][а-яё]*\s[А-ЯЁ][а-яё]*$/,
        u = /^(\d+)[.](\d+)[.](\d+)/;
    16 === n.find(s).val().length ? "" !== n.find(r).val() || u.test(n.find(r).val()) ? "" !== n.find(i).val() && d.test(n.find(i).val()) ? "child" === $("#selected_sender_" + t[1]).val() ? $.ajax({
        ...
        beforeSend: function() {},
        success: function(e) {
            if ("false" === e) $("#success_" + t[1]).html(""), $("#error_" + t[1]).html("Заполните дату оплаты услуг");
            else {
                $("#save_" + t[1]).css("display", "none"), n.find(i).css("display", "none"), n.find(s).css("display", "none"), n.find(r).css("display", "none"), a.html(n.find(i).val()), o.html(n.find(s).val()), l.html(n.find(r).val()), $("#edit_" + t[1]).css("display", "inline-block"), $("#success_" + t[1]).html(e), $("#error_" + t[1]).html(""), a.css("display", "block"), o.css("display", "block"), l.css("display", "block");
                var c = l.text().replace(/\s/g, ""),
                    d = n.find(s).val();
                d = d.replace(/\s/g, "");
                var u = n.find(i).val();
                u = u.replace(/\s/g, ""), c.length <= 3 || d.length <= 1 || u.length <= 3 || $("#children_input_" + t[1]).attr("data-id_child").length > 0 && $.ajax({
                    url: "/pdf/file_children_pdf.php",
                    data: {
                        id: $("#children_input_" + t[1]).attr("data-id_child"),
                        oplata: $("#time_" + t[1]).text(),
                        id_obr: t[1]
                    },
                    type: "post",
                    success: function(e) {
                        $("[data-obrashenie-id=" + t[1] + "]").find(".pdf").attr("href", e), $("[data-obrashenie-id=" + t[1] + "]").find(".pdf").removeClass("error"), $("[data-obrashenie-id=" + t[1] + "]").find(".pdf").text("Просмотреть"), $(".ready_pdf").removeClass("hidden"), $(".with_out_pdf").addClass("hidden"), $(".datepicker-here_" + t[1]).remove(), 0 !== $("[data-block_img=" + t[1] + "]").find("[id*=img_block_" + t[1]).length && ($("#send_" + t[1]).attr("onclick", "send_ms(this)"), $("#send_" + t[1]).removeClass("disabled"))
                    }
                })
            }
        }
    }) : "my" === $("#selected_sender_" + t[1]).val() && $.ajax({
        url: "/ajax/edit_appeal.php",
        data: {
            ID: t[1],
            NAME: n.find(i).val(),
        ...
        success: function(e) {
            if ("false" === e) $("#success_" + t[1]).html(""), $("#error_" + t[1]).html("Заполните дату оплаты услуг");
                ...
                $("#save_" + t[1]).css("display", "none"), n.find(i).css("display", "none"), n.find(s).css("display", "none"), n.find(r).css("display", "none"), a.html(n.find(i).val()), o.html(n.find(s).val()), l.html(n.find(r).val()), $("#edit_" + t[1]).css("display", "inline-block"), $("#success_" + t[1]).html(e), $("#error_" + t[1]).html(""), a.css("display", "block"), o.css("display", "block"), l.css("display", "block");
                var d = l.text().replace(/\s/g, ""),
                    u = n.find(s).val();
                u = u.replace(/\s/g, "");
                var p = n.find(i).val();
                if (p = p.replace(/\s/g, ""), d.length <= 3 || u.length <= 1 || p.length <= 3);
                else {
                    let e = {
                        number_polic: n.find(s).val(),
                        data_user_oplata_POST: l.text(),
                        data_checkout: "1",
                        usrname: n.find(i).val(),
                        id: t[1],
                        hospitl: n.find(c).text()
                    };
                    $.ajax({
                        ...
                        data: e,
                        success: function(e) {
                            $("[data-obrashenie-id=" + t[1] + "]").find(".pdf").attr("href", e), $("[data-obrashenie-id=" + t[1] + "]").find(".pdf").removeClass("error"), $("[data-obrashenie-id=" + t[1] + "]").find(".pdf").text("Просмотреть"), $(".ready_pdf").removeClass("hidden"), $(".with_out_pdf").addClass("hidden")
                        }
                    }).done(function(e) {
                        $(".datepicker-here_" + t[1]).remove(), 0 !== $("[data-block_img=" + t[1] + "]").find("[id*=img_block_" + t[1]).length && ($("#send_" + t[1]).attr("onclick", "send_ms(this)"), $("#send_" + t[1]).removeClass("disabled"))
                    })
                }
            }
        }
    }) : ($("#success_" + t[1]).html(""), $("#error_" + t[1]).html('Введите ФИО в формате: "Фамилия Имя Отчество"')) : ($("#success_" + t[1]).html(""), $("#error_" + t[1]).html("Введите корректно дату")) : ($("#success_" + t[1]).html(""), $("#error_" + t[1]).html("Введите корректно полис"))
}

function send_ms(e) {
    let t = $(e)[0].id.split("_");
    if ("my" === $("#selected_sender_" + t[1]).val()) {
        let e = $("#appeal_" + t[1]),
            n = $("input[name='usrname']"),
            i = $("input[name='policy']"),
            s = $("#hospitl_" + t[1]),
            r = $("#time_" + t[1]),
            a = {
                number_polic: e.find(i).val(),
                data_user_oplata_POST: r.text(),
                data_checkout: "2",
                usrname: e.find(n).val(),
                id: t[1],
                hospitl: e.find(s).text()
            };
        "" != r.text() && $.ajax({
            url: "/pdf/file_pdf.php",
            type: "POST",
            data: a,
            success: function(e) {
                -1 != r.text().search("2") && ($("[data-obrashenie-id=" + t[1] + "]").find(".pdf").attr("href", e), $(".ready_pdf").is(":visible") && $(".ready_pdf").addClass("hidden"), $(".updata_pdf").removeClass("hidden")), $.ajax({
                    ...
                    success: function(e) {
                        let n = JSON.parse(e),
                            i = $("#error_" + t[1]),
                            s = $("#success_" + t[1]);
                        void 0 !== n.error ? (i.text(n.error), s.text("")) : void 0 !== n.success && ($("#appeal_" + t[1]).addClass("sended"), $.magnificPopup.open({
                            items: {
                        ...
                        }), i.text(""), s.text(n.success))
                    }
                })
            }
        })
    } else "child" === $("#selected_sender_" + t[1]).val() && $("#children_input_" + t[1]).attr("data-id_child").length > 0 && "" !== $("#time_" + t[1]).text() && $.ajax({
        url: "/pdf/file_children_pdf.php",
        data: {
            id: $("#children_input_" + t[1]).attr("data-id_child"),
            oplata: $("#time_" + t[1]).text(),
        ...
        type: "post",
        success: function(e) {
            -1 !== $("#time_" + t[1]).text().search("2") && ($("[data-obrashenie-id=" + t[1] + "]").find(".pdf").attr("href", e), $(".ready_pdf").is(":visible") && $(".ready_pdf").addClass("hidden"), $(".updata_pdf").removeClass("hidden")), $.ajax({
                url: "/ajax/send_message.php",
                data: {
                    ID: t[1],
                    CHILD: $("#children_input_" + t[1]).attr("data-id_child")
                },
                type: "post",
                success: function(e) {
                    let n = JSON.parse(e),
...
function commutator(e, t) {
    if ("child" === e) "" != $("#children_input_" + t).attr("data-id_child") && $.ajax({
        url: "/pdf/file_children_pdf.php",
        data: {
            id: $("#children_input_" + t).attr("data-id_child"),
            oplata: $("#time_" + t).text(),
            id_obr: t
        },
        type: "post",
        success: function(e) {
            $("[data-obrashenie-id=" + t + "]").find(".pdf").attr("href", e), $("[data-obrashenie-id=" + t + "]").find(".pdf").removeClass("error"), $("[data-obrashenie-id=" + t + "]").find(".pdf").text("Просмотреть"), $(".ready_pdf").removeClass("hidden"), $(".with_out_pdf").addClass("hidden")
        }
    });
    else if ("my" === e) {
        let e = $("#appeal_" + t),
            ...
            a = {
                number_polic: e.find(i).val(),
                data_user_oplata_POST: s.text(),
                data_checkout: "1",
                usrname: e.find(n).val(),
                id: t,
                hospitl: e.find(r).text()
            }; - 1 !== s.text().search(".20") && $.ajax({
            url: "/pdf/file_pdf.php",
            type: "POST",
            data: a,
            success: function(e) {
...
function edit_date(e) {
    var t = $(e).attr("data-id-date_picker_edit");
    $("[data-id-date_picker_edit=" + t + "]").css({
        display: "none"
    }), $("[data-id-date_picker_save=" + t + "]").css({
        display: "block"
    }), $("#date_picker_" + t).css({
        display: "block"
    }), $("#edit_" + t).removeAttr("onclick"), $("#time_" + t).css({
        display: "none"
    }), $(".start_" + t).remove()
}

function save_date(e) {
    var t = $(e).attr("data-id-date_picker_save");
    let n = $("input[name='usrname']"),
        i = $("#appeal_" + t),
        s = $("input[name='policy']"),
        r = $("input[name='time']"),
        a = $("#usrname_" + t),
        ...
        l = $("#time_" + t),
        c = $("#hospitl_" + t);
    "" !== i.find(r).val() || /^(\d+)[.](\d+)[.](\d+)/.test(i.find(r).val()) ? "child" === $("#selected_sender_" + t).val() ? $.ajax({
        url: "/ajax/edit_appeal.php",
        data: {
            ID: t,
            TIME: i.find(r).val(),
        ...
        success: function(e) {
            if ("false" === e) $("#success_" + t).html(""), $("#error_" + t).html("Заполните дату оплаты услуг"), $("#gif_" + t).css({
                display: "none"
            });
            else {
                i.find(n).css("display", "none"), i.find(s).css("display", "none"), i.find(r).css("display", "none"), a.html(i.find(n).val()), o.html(i.find(s).val()), l.html(i.find(r).val()), $("#edit_" + t).css("display", "inline-block"), $("#success_" + t).html(e), $("#error_" + t).html(""), a.css("display", "block"), o.css("display", "block"), l.css("display", "block");
                var c = l.text().replace(/\s/g, ""),
                    d = i.find(s).val();
                d = d.replace(/\s/g, "");
                var u = i.find(n).val();
                u = u.replace(/\s/g, ""), $("#gif_" + t).css({
                    display: "none"
                }), $(".datepicker-here_" + t).remove(), $("[data-id-date_picker_save=" + t + "]").css({
                    display: "none"
                }), $("[data-id-date_picker_edit=" + t + "]").css({
                    display: "block"
                }), 

//$("#svg_edit_" + t).attr("src", "/local/templates/kdteam/images/svg/edit.svg"), 
//alert(),
c.length <= 3 || d.length <= 1 || u.length <= 3 ? $("#gif_" + t).css({
                    display: "none"
                }) : "" != $("#children_input_" + t).attr("data-id_child") && $.ajax({
                    url: "/pdf/file_children_pdf.php",
                    data: {
                        id: $("#children_input_" + t).attr("data-id_child"),
                        oplata: $("#time_" + t).text(),
                    ...
                    type: "post",
                    success: function(e) {
                        console.log("success"), $("[data-obrashenie-id=" + t + "]").find(".pdf").attr("href", e), $("[data-obrashenie-id=" + t + "]").find(".pdf").removeClass("error"), $("[data-obrashenie-id=" + t + "]").find(".pdf").text("Просмотреть"), $(".ready_pdf").removeClass("hidden"), $(".with_out_pdf").addClass("hidden"), $("#gif_" + t).css({
                            display: "none"
                        }), $("[data-id-date_picker_save=" + t + "]").css({
                            display: "none"
                        }), $("[data-id-date_picker_edit=" + t + "]").css({
...
$("#edit_" + t).attr("onclick", "edit(this)"), $(".datepicker-here_" + t).remove(), 0 !== $("[data-block_img=" + t + "]").find("[id*=img_block_" + t).length && "-1" != $("#time_" + t).text().search("2") && ($("#send_" + t).attr("onclick", "send_ms(this)"), $("#send_" + t).removeClass("disabled"))
                    }
                })
            }
        }
    }) : "my" === $("#selected_sender_" + t).val() && $.ajax({
        url: "/ajax/edit_appeal.php",
        data: {
            ID: t,
            CASE: "case",
        ...
        success: function(e) {
            if ("false" === e) $("#success_" + t).html(""), $("#error_" + t).html("Заполните дату оплаты услуг"), $("#gif_" + t).css({
                ...
                if (p = p.replace(/\s/g, ""), d.length <= 3 || u.length <= 1 || p.length <= 3);
                    ...
                    let e = {
                        number_polic: i.find(s).val(),
                        data_user_oplata_POST: l.text(),
                        data_checkout: "1",
                        usrname: i.find(n).val(),
                        id: t,
                        hospitl: i.find(c).text()
                    };
                    $.ajax({
                        url: "/pdf/file_pdf.php",
                        type: "POST",
...
$("#date_picker_" + t).css({
    ...
    }) : ($("#success_" + t).html(""), $("#error_" + t).html("Введите корректно дату"))
}! function(e, t) {
    "use strict";
    ...
    function y(e, t, n) {
        var s, r, a = (n = n || i).createElement("script");
        if (a.text = e, t)
            for (s in v)(r = t[s] || t.getAttribute && t.getAttribute(s)) && a.setAttribute(s, r);
    ...
    x.fn = x.prototype = {
        ...
        for ("boolean" == typeof a && (c = a, a = arguments[o] || {}, o++), "object" == typeof a || m(a) || (a = {}), o === l && (a = this, o--); o < l; o++)
            if (null != (e = arguments[o]))
                for (t in e) i = e[t], "__proto__" !== t && a !== i && (c && i && (x.isPlainObject(i) || (s = Array.isArray(i))) ? (n = a[t], r = s && !Array.isArray(n) ? [] : s || x.isPlainObject(n) ? n : {}, s = !1, a[t] = x.extend(c, r, i)) : void 0 !== i && (a[t] = i));
        return a
    }, x.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== d.call(e) || (t = s(e)) && ("function" != typeof(n = u.call(t, "constructor") && t.constructor) || p.call(n) !== h))
        },
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (k(Object(e)) ? x.merge(n, "string" == typeof e ? [e] : e) : o.call(n, e)), n
        },
    ...
    var C = function(e) {
        var t, n, i, s, r, a, o, l, c, d, u, p, h, f, m, g, v, y, b, _ = "sizzle" + 1 * new Date,
            x = e.document,
            w = 0,
            k = 0,
            C = le(),
        ...
        try {
            A.apply(M = H.call(x.childNodes), x.childNodes), M[x.childNodes.length].nodeType
        } catch (t) {
            A = {
        ...
        function oe(e, t, i, s) {
            var r, o, c, d, u, f, v, y = t && t.ownerDocument,
                w = t ? t.nodeType : 9;
            ...
            if (!s && ((t ? t.ownerDocument || t : x) !== h && p(t), t = t || h, m)) {
                ...
                if (n.qsa && !T[e + " "] && (!g || !g.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    if (v = e, y = t, 1 === w && V.test(e)) {
                        for ((d = t.getAttribute("id")) ? d = d.replace(ie, se) : t.setAttribute("id", d = _), o = (f = a(e)).length; o--;) f[o] = "#" + d + " " + be(f[o]);
        ...
        for (t in n = oe.support = {}, r = oe.isXML = function(e) {
                ...
                return a !== h && 9 === a.nodeType && a.documentElement && (f = (h = a).documentElement, m = !r(h), x !== h && (s = h.defaultView) && s.top !== s && (s.addEventListener ? s.addEventListener("unload", re, !1) : s.attachEvent && s.attachEvent("onunload", re)), n.attributes = de(function(e) {
                    ...
                    return i || (1 & (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === i ? e === h || e.ownerDocument === x && b(x, e) ? -1 : t === h || t.ownerDocument === x && b(x, t) ? 1 : d ? j(d, e) - j(d, t) : 0 : 4 & i ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return u = !0, 0;
                    var n, i = 0,
                        s = e.parentNode,
                        ...
                        a = [e],
                        o = [t];
                    if (!s || !r) return e === h ? -1 : t === h ? 1 : s ? -1 : r ? 1 : d ? j(d, e) - j(d, t) : 0;
                ...
                if ((e.ownerDocument || e) !== h && p(e), n.matchesSelector && m && !T[t + " "] && (!v || !v.test(t)) && (!g || !g.test(t))) try {
                    var i = y.call(e, t);
                ...
                var s = i.attrHandle[t.toLowerCase()],
                    r = s && E.call(i.attrHandle, t.toLowerCase()) ? s(e, t, !m) : void 0;
                ...
                var t, i = [],
                    s = 0,
                    r = 0;
                if (u = !n.detectDuplicates, d = !n.sortStable && e.slice(0), e.sort(S), u) {
                ...
                filter: {
                    ...
                    ATTR: function(e, t, n) {
                        return function(i) {
                            var s = oe.attr(i, e);
                            return null == s ? "!=" === t : !t || (s += "", "=" === t ? s === n : "!=" === t ? s !== n : "^=" === t ? n && 0 === s.indexOf(n) : "*=" === t ? n && -1 < s.indexOf(n) : "$=" === t ? n && s.slice(-n.length) === n : "~=" === t ? -1 < (" " + s.replace(q, " ") + " ").indexOf(n) : "|=" === t && (s === n || s.slice(0, n.length + 1) === n + "-"))
                        }
                    },
                    CHILD: function(e, t, n, i, s) {
                        ...
                        return 1 === i && 0 === s ? function(e) {
                            ...
                            var c, d, u, p, h, f, m = r !== a ? "nextSibling" : "previousSibling",
                                g = t.parentNode,
                            ...
                            if (g) {
                                ...
                                if (f = [a ? g.firstChild : g.lastChild], a && y) {
                                    for (b = (h = (c = (d = (u = (p = g)[_] || (p[_] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === w && c[1]) && c[2], p = h && g.childNodes[h]; p = ++h && p && p[m] || (b = h = 0) || f.pop();)
                                        if (1 === p.nodeType && ++b && p === t) {
                                            d[e] = [w, h, b];
                                            break
                                        }
                                } else if (y && (b = h = (c = (d = (u = (p = t)[_] || (p[_] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === w && c[1]), !1 === b)
                                    for (;
                                        (p = ++h && p && p[m] || (b = h = 0) || f.pop()) && ((o ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && ((d = (u = p[_] || (p[_] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [w, b]), p !== t)););
                    ...
                    PSEUDO: function(e, t) {
                        ...
                        return s[_] ? s(t) : 1 < s.length ? (n = [e, e, "", t], i.setFilters.hasOwnProperty(e.toLowerCase()) ? ce(function(e, n) {
                            for (var i, r = s(e, t), a = r.length; a--;) e[i = j(e, r[a])] = !(n[i] = r[a])
                        }) : function(e) {
                            return s(e, 0, n)
                        }) : s
                    }
                ...
                pseudos: {
                    not: ce(function(e) {
                        ...
                        return i[_] ? ce(function(e, t, n, s) {
                            for (var r, a = i(e, null, s, []), o = e.length; o--;)(r = a[o]) && (e[o] = !(t[o] = r))
                        }) : function(e, s, r) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || a)
                            if (d = (u = t[_] || (t[_] = {}))[t.uniqueID] || (u[t.uniqueID] = {}), s && s === t.nodeName.toLowerCase()) t = t[i] || t;
                                ...
                                if ((c = d[r]) && c[0] === w && c[1] === o) return p[2] = c[2];
        ...
        function we(e, t, n, i, s) {
            for (var r, a = [], o = 0, l = e.length, c = null != t; o < l; o++)(r = e[o]) && (n && !n(r, i, s) || (a.push(r), c && t.push(o)));
            return a
        }

        function ke(e, t, n, i, s, r) {
            return i && !i[_] && (i = ke(i)), s && !s[_] && (s = ke(s, r)), ce(function(r, a, o, l) {
                var c, d, u, p = [],
                    h = [],
                    f = a.length,
                    m = r || function(e, t, n) {
                    ...
                    g = !e || !r && t ? m : we(m, p, e, o, l),
                    v = n ? s || (r ? e : f || i) ? [] : a : g;
                if (n && n(g, v, o, l), i)
                    for (c = we(v, h), i(c, [], o, l), d = c.length; d--;)(u = c[d]) && (v[h[d]] = !(g[h[d]] = u));
                if (r) {
                    if (s || e) {
                        if (s) {
                        ...
                        for (d = v.length; d--;)(u = v[d]) && -1 < (c = s ? j(r, u) : p[d]) && (r[c] = !(a[c] = u))
                    }
                } else v = we(v === a ? v.splice(f, v.length) : v), s ? s(null, a, v, l) : A.apply(a, v)
            })
        }

        function Ce(e) {
            for (var t, n, s, r = e.length, a = i.relative[e[0].type], o = a || i.relative[" "], l = a ? 1 : 0, d = _e(function(e) {
                    return e === t
                }, o, !0), u = _e(function(e) {
                    return -1 < j(t, e)
                ...
                if (n = i.relative[e[l].type]) p = [_e(xe(p), n)];
                else {
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[_]) {
                        for (s = ++l; s < r && !i.relative[e[s].type]; s++);
                        return ke(1 < l && xe(p), 1 < l && be(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(B, "$1"), n, l < s && Ce(e.slice(l, s)), s < r && Ce(e = e.slice(s)), s < r && be(e))
                    }
                    p.push(n)
                }
            return xe(p)
        ...
        return ye.prototype = i.filters = i.pseudos, i.setFilters = new ye, a = oe.tokenize = function(e, t) {
            var n, s, r, a, o, l, c, d = D[e + " "];
            if (d) return t ? 0 : d.slice(0);
            for (o = e, l = [], c = i.preFilter; o;) {
                for (a in n && !(s = W.exec(o)) || (s && (o = o.slice(s[0].length) || o), l.push(r = [])), n = !1, (s = z.exec(o)) && (n = s.shift(), r.push({
                        value: n,
                        type: s[0].replace(B, " ")
                    }), o = o.slice(n.length)), i.filter) !(s = K[a].exec(o)) || c[a] && !(s = c[a](s)) || (n = s.shift(), r.push({
                    value: n,
                    type: a,
                    matches: s
                }), o = o.slice(n.length));
            ...
            return t ? o.length : o ? oe.error(e) : D(e, l).slice(0)
        }, o = oe.compile = function(e, t) {
            var n, s, r, o, l, d, u = [],
                f = [],
                g = $[e + " "];
            if (!g) {
                for (t || (t = a(e)), n = t.length; n--;)(g = Ce(t[n]))[_] ? u.push(g) : f.push(g);
                (g = $(e, (s = f, o = 0 < (r = u).length, l = 0 < s.length, d = function(e, t, n, a, d) {
                    var u, f, g, v = 0,
                        y = "0",
                        b = e && [],
                        _ = [],
                        ...
                        D = k.length;
                    for (d && (c = t === h || t || d); y !== D && null != (u = k[y]); y++) {
                        if (l && u) {
                        ...
                        o && ((u = !g && u) && v--, e && b.push(u))
                    }
                    if (v += y, o && y !== v) {
                        for (f = 0; g = r[f++];) g(b, _, t, n);
                        if (e) {
                            if (0 < v)
                                for (; y--;) b[y] || _[y] || (_[y] = I.call(a));
                            _ = we(_)
                        }
                        A.apply(a, _), d && !e && 0 < _.length && 1 < v + r.length && oe.uniqueSort(a)
                    }
                    return d && (w = C, c = x), b
                }, o ? ce(d) : d))).selector = e
            }
        ...
        }, n.sortStable = _.split("").sort(S).join("") === _, n.detectDuplicates = !!u, p(), n.sortDetached = de(function(e) {
    ...
    (x.fn.init = function(e, t, n) {
        ...
        if (n = n || I, "string" == typeof e) {
            if (!(s = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : N.exec(e)) || !s[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
            if (s[1]) {
                if (t = t instanceof x ? t[0] : t, x.merge(this, x.parseHTML(s[1], t && t.nodeType ? t.ownerDocument || t : i, !0)), E.test(s[1]) && x.isPlainObject(t))
    ...
    x.fn.extend({
        ...
        x.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (s = x.filter(i, s)), 1 < this.length && (H[e] || x.uniqueSort(s), A.test(e) && s.reverse()), this.pushStack(s)
        }
    });
    var P = /[^\x20\t\r\n\f]+/g;
    ...
    x.Callbacks = function(e) {
        ...
        var i, s, r, a, o = [],
            ...
            d = function() {
                for (a = a || e.once, r = i = !0; l.length; c = -1)
                    for (s = l.shift(); ++c < o.length;) !1 === o[c].apply(s[0], s[1]) && e.stopOnFalse && (c = o.length, s = !1);
                e.memory || (s = !1), i = !1, a && (o = s ? [] : "")
            },
            u = {
                add: function() {
                    return o && (s && !i && (c = o.length - 1, l.push(s)), function t(n) {
                ...
                remove: function() {
                    return x.each(arguments, function(e, t) {
                        for (var n; - 1 < (n = x.inArray(t, o, n));) o.splice(n, 1), n <= c && c--
                    }), this
                },
                has: function(e) {
                ...
                s = {
                    ...
                    then: function(t, i, s) {
                                ...
                                var o = this,
                                    ...
                                    c = function() {
                                        ...
                                        if (!(t < r)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, m(c) ? s ? c.call(e, a(r, n, O, s), a(r, n, L, s)) : (r++, c.call(e, a(r, n, O, s), a(r, n, L, s), a(r, n, O, n.notifyWith))) : (i !== O && (o = void 0, l = [e]), (s || n.resolveWith)(o, l))
                                        }
                                    },
                                    d = s ? c : function() {
                                        try {
                                            ...
                                            x.Deferred.exceptionHook && x.Deferred.exceptionHook(e, d.stackTrace), r <= t + 1 && (i !== L && (o = void 0, l = [e]), n.rejectWith(o, l))
                                        }
                                    };
                        ...
                        return x.Deferred(function(e) {
                            n[0][3].add(a(0, e, m(s) ? s : O, e.notifyWith)), n[1][3].add(a(0, e, m(t) ? t : O)), n[2][3].add(a(0, e, m(i) ? i : L))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            var t = arguments.length,
                ...
                o = function(e) {
                    return function(n) {
                        i[e] = this, s[e] = 1 < arguments.length ? r.call(arguments) : n, --t || a.resolveWith(i, s)
                    }
                };
            if (t <= 1 && (R(e, a.done(o(n)).resolve, a.reject, !t), "pending" === a.state() || m(s[n] && s[n].then))) return a.then();
            for (; n--;) R(s[n], o(n), a.reject);
            return a.promise()
        }
    });
    ...
    x.fn.ready = function(e) {
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --x.readyWait : x.isReady) || (x.isReady = !0) !== e && 0 < --x.readyWait || q.resolveWith(i, [x])
        }
    }), x.ready.then = q.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(x.ready) : (i.addEventListener("DOMContentLoaded", B), e.addEventListener("load", B));
    var W = function(e, t, n, i, s, r, a) {
            var o = 0,
                l = e.length,
                c = null == n;
            if ("object" === b(n))
                for (o in s = !0, n) W(e, t, o, n[o], !0, r, a);
            else if (void 0 !== i && (s = !0, m(i) || (a = !0), c && (a ? (t.call(e, i), t = null) : (c = t, t = function(e, t, n) {
                    return c.call(x(e), n)
                })), t))
    ...
    x.extend({
        ...
        data: function(e, t) {
            var n, i, s, r = this[0],
                a = r && r.attributes;
            if (void 0 === e) {
                if (this.length && (s = Z.get(r), 1 === r.nodeType && !G.get(r, "hasDataAttrs"))) {
                    for (n = a.length; n--;) a[n] && 0 === (i = a[n].name).indexOf("data-") && (i = Y(i.slice(5)), ee(r, i, s[i]));
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n;
                if (r && void 0 === t) return void 0 !== (n = Z.get(r, e)) ? n : void 0 !== (n = ee(r, e)) ? n : void 0;
                this.each(function() {
                    Z.set(this, e, t)
                })
        ...
        promise: function(e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--;)(n = G.get(r[a], e + "queueHooks")) && n.empty && (i++, n.empty.add(o));
    ...
    function xe(e, t, n, i, s) {
        for (var r, a, o, l, c, d, u = t.createDocumentFragment(), p = [], h = 0, f = e.length; h < f; h++)
            ...
            for (a = a || u.appendChild(t.createElement("div")), o = (he.exec(r) || ["", ""])[1].toLowerCase(), l = me[o] || me._default, a.innerHTML = l[1] + x.htmlPrefilter(r) + l[2], d = l[0]; d--;) a = a.lastChild;
            x.merge(p, a.childNodes), (a = u.firstChild).textContent = ""
        } else p.push(t.createTextNode(r));
        for (u.textContent = "", h = 0; r = p[h++];)
            if (i && -1 < x.inArray(r, i)) s && s.push(r);
            else if (c = re(r), a = ge(u.appendChild(r), "script"), c && ve(a), n)
            for (d = 0; r = a[d++];) fe.test(r.type || "") && n.push(r);
        return u
    }
    ye = i.createDocumentFragment().appendChild(i.createElement("div")), (be = i.createElement("input")).setAttribute("type", "radio"), be.setAttribute("checked", "checked"), be.setAttribute("name", "t"), ye.appendChild(be), f.checkClone = ye.cloneNode(!0).cloneNode(!0).lastChild.checked, ye.innerHTML = "<textarea>x</textarea>", f.noCloneChecked = !!ye.cloneNode(!0).lastChild.defaultValue;
    var we = /^key/,
    ...
    function Se(e, t, n, i, s, r) {
        var a, o;
        if ("object" == typeof t) {
            for (o in "string" != typeof n && (i = i || n, n = void 0), t) Se(e, o, n, i, t[o], r);
            return e
        }
        if (null == i && null == s ? (s = n, i = n = void 0) : null == s && ("string" == typeof n ? (s = i, i = void 0) : (s = i, i = n, n = void 0)), !1 === s) s = $e;
        else if (!s) return e;
    ...
    function Ee(e, t, n) {
        n ? (G.set(e, t, !1), x.event.add(e, t, {
            namespace: !1,
            handler: function(e) {
                var i, s, a = G.get(this, t);
                if (1 & e.isTrigger && this[t]) {
                    if (a.length)(x.event.special[t] || {}).delegateType && e.stopPropagation();
                    else if (a = r.call(arguments), G.set(this, t, a), i = n(this, t), this[t](), a !== (s = G.get(this, t)) || i ? G.set(this, t, !1) : s = {}, a !== s) return e.stopImmediatePropagation(), e.preventDefault(), s.value
                } else a.length && (G.set(this, t, {
                    value: x.event.trigger(x.extend(a[0], x.Event.prototype), a.slice(1), this)
                }), e.stopImmediatePropagation())
            }
        })) : void 0 === G.get(e, t) && x.event.add(e, t, De)
    }
    x.event = {
        global: {},
        add: function(e, t, n, i, s) {
            var r, a, o, l, c, d, u, p, h, f, m, g = G.get(e);
            if (g)
                for (n.handler && (n = (r = n).handler, s = r.selector), s && x.find.matchesSelector(se, s), n.guid || (n.guid = x.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function(t) {
                        return void 0 !== x && x.event.triggered !== t.type ? x.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(P) || [""]).length; c--;) h = m = (o = Ce.exec(t[c]) || [])[1], f = (o[2] || "").split(".").sort(), h && (u = x.event.special[h] || {}, h = (s ? u.delegateType : u.bindType) || h, u = x.event.special[h] || {}, d = x.extend({
                    type: h,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, r), (p = l[h]) || ((p = l[h] = []).delegateCount = 0, u.setup && !1 !== u.setup.call(e, i, f, a) || e.addEventListener && e.addEventListener(h, a)), u.add && (u.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), s ? p.splice(p.delegateCount++, 0, d) : p.push(d), x.event.global[h] = !0)
        },
        remove: function(e, t, n, i, s) {
            var r, a, o, l, c, d, u, p, h, f, m, g = G.hasData(e) && G.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--;)
                    if (h = m = (o = Ce.exec(t[c]) || [])[1], f = (o[2] || "").split(".").sort(), h) {
                        for (u = x.event.special[h] || {}, p = l[h = (i ? u.delegateType : u.bindType) || h] || [], o = o[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = p.length; r--;) d = p[r], !s && m !== d.origType || n && n.guid !== d.guid || o && !o.test(d.namespace) || i && i !== d.selector && ("**" !== i || !d.selector) || (p.splice(r, 1), d.selector && p.delegateCount--, u.remove && u.remove.call(e, d));
                        a && !p.length && (u.teardown && !1 !== u.teardown.call(e, f, g.handle) || x.removeEvent(e, h, g.handle), delete l[h])
                    } else
        ...
        dispatch: function(e) {
            var t, n, i, s, r, a, o = x.event.fix(e),
            ...
            if (o.delegateTarget = this, !d.preDispatch || !1 !== d.preDispatch.call(this, o)) {
                for (a = x.event.handlers.call(this, o, c), t = 0;
                    ...
                    for (o.currentTarget = s.elem, n = 0;
                        (r = s.handlers[n++]) && !o.isImmediatePropagationStopped();) o.rnamespace && !1 !== r.namespace && !o.rnamespace.test(r.namespace) || (o.handleObj = r, o.data = r.data, void 0 !== (i = ((x.event.special[r.origType] || {}).handle || r.handler).apply(s.elem, l)) && !1 === (o.result = i) && (o.preventDefault(), o.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && 1 <= e.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (r = [], a = {}, n = 0; n < l; n++) void 0 === a[s = (i = t[n]).selector + " "] && (a[s] = i.needsContext ? -1 < x(s, this).index(c) : x.find(s, this, null, [c]).length), a[s] && r.push(i);
                        r.length && o.push({
                            elem: c,
                            handlers: r
                        })
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && S(t, "input") && Ee(t, "click", De), !1
                },
                trigger: function(e) {
                    var t = this || e;
                ...
                _default: function(e) {
                    var t = e.target;
                    return pe.test(t.type) && t.click && S(t, "input") && G.get(t, "click") || S(t, "a")
                }
            },
            beforeunload: {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? De : $e, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && x.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[x.expando] = !0
    }, x.Event.prototype = {
        constructor: x.Event,
    ...
    function Oe(e, t) {
        var n, i, s, r, a, o, l, c;
        if (1 === t.nodeType) {
            if (G.hasData(e) && (r = G.access(e), a = G.set(t, r), c = r.events))
                for (s in delete a.handle, a.events = {}, c)
                    for (n = 0, i = c[s].length; n < i; n++) x.event.add(t, s, c[s][n]);
            Z.hasData(e) && (o = Z.access(e), l = x.extend({}, o), Z.set(t, l))
        }
    }
    ...
    function Le(e, t, n, i) {
        ...
        var s, r, o, l, c, d, u = 0,
            ...
            g = t[0],
            v = m(g);
        if (v || 1 < p && "string" == typeof g && !f.checkClone && Ne.test(g)) return e.each(function(s) {
            var r = e.eq(s);
            v && (t[0] = g.call(this, s, r.html())), Le(r, t, n, i)
        });
        if (p && (r = (s = xe(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === s.childNodes.length && (s = r), r || i)) {
            for (l = (o = x.map(ge(s, "script"), je)).length; u < p; u++) c = s, u !== h && (c = x.clone(c, !0, !0), l && x.merge(o, ge(c, "script"))), n.call(e[u], c, u);
            if (l)
                for (d = o[o.length - 1].ownerDocument, x.map(o, Pe), u = 0; u < l; u++) c = o[u], fe.test(c.type || "") && !G.access(c, "globalEval") && x.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? x._evalUrl && !c.noModule && x._evalUrl(c.src, {
                    nonce: c.nonce || c.getAttribute("nonce")
                }) : y(c.textContent.replace(Ae, ""), c, d))
        }
        return e
    }

    function Re(e, t, n) {
        for (var i, s = t ? x.filter(t, e) : e, r = 0; null != (i = s[r]); r++) n || 1 !== i.nodeType || x.cleanData(ge(i)), i.parentNode && (n && re(i) && ve(ge(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    x.extend({
        ...
        clone: function(e, t, n) {
            var i, s, r, a, o, l, c, d = e.cloneNode(!0),
                u = re(e);
            if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || x.isXMLDoc(e)))
                for (a = ge(d), i = 0, s = (r = ge(e)).length; i < s; i++) o = r[i], "input" === (c = (l = a[i]).nodeName.toLowerCase()) && pe.test(o.type) ? l.checked = o.checked : "input" !== c && "textarea" !== c || (l.defaultValue = o.defaultValue);
            if (t)
                if (n)
                    for (r = r || ge(e), a = a || ge(d), i = 0, s = r.length; i < s; i++) Oe(r[i], a[i]);
                else Oe(e, d);
            return 0 < (a = ge(d, "script")).length && ve(a, !u && ge(e, "script")), d
        },
        ...
        x.fn[e] = function(e) {
            for (var n, i = [], s = x(e), r = s.length - 1, a = 0; a <= r; a++) n = a === r ? this : this.clone(!0), x(s[a])[t](n), o.apply(i, n.get());
    ...
    function We(e, t, n) {
        ...
        return (n = n || qe(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || re(e) || (a = x.style(e, t)), !f.pixelBoxStyles() && Fe.test(a) && Be.test(t) && (i = o.width, s = o.minWidth, r = o.maxWidth, o.minWidth = o.maxWidth = o.width = a, a = n.width, o.width = i, o.minWidth = s, o.maxWidth = r)), void 0 !== a ? a + "" : a
    }
    ...
    function ze(e, t) {
        ...
        function t() {
            if (d) {
                ...
                s = "1%" !== t.top, l = 12 === n(t.marginLeft), d.style.right = "60%", o = 36 === n(t.right), r = 36 === n(t.width), d.style.position = "absolute", a = 12 === n(d.offsetWidth / 3), se.removeChild(c), d = null
            }
        }
        ...
        var s, r, a, o, l, c = i.createElement("div"),
    ...
    function Ke(e) {
        return x.cssProps[e] || Ye[e] || (e in Ue ? e : Ye[e] = function(e) {
    ...
    function et(e, t, n, i, s, r) {
        ...
        for (; a < 4; a += 2) "margin" === n && (l += x.css(e, n + ie[a], !0, s)), i ? ("content" === n && (l -= x.css(e, "padding" + ie[a], !0, s)), "margin" !== n && (l -= x.css(e, "border" + ie[a] + "Width", !0, s))) : (l += x.css(e, "padding" + ie[a], !0, s), "padding" !== n ? l += x.css(e, "border" + ie[a] + "Width", !0, s) : o += x.css(e, "border" + ie[a] + "Width", !0, s));
        return !i && 0 <= r && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - r - l - o - .5)) || 0), l
    }

    function tt(e, t, n) {
        var i = qe(e),
            s = (!f.boxSizingReliable() || n) && "border-box" === x.css(e, "boxSizing", !1, i),
            r = s,
            a = We(e, t, i),
        ...
        return (!f.boxSizingReliable() && s || "auto" === a || !parseFloat(a) && "inline" === x.css(e, "display", !1, i)) && e.getClientRects().length && (s = "border-box" === x.css(e, "boxSizing", !1, i), (r = o in e) && (a = e[o])), (a = parseFloat(a) || 0) + et(e, t, n || (s ? "border" : "content"), r, i, a) + "px"
    }
    ...
    x.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var s, r, a, o = Y(t),
                    l = Ge.test(t),
                    c = e.style;
                if (l || (t = Ke(o)), a = x.cssHooks[t] || x.cssHooks[o], void 0 === n) return a && "get" in a && void 0 !== (s = a.get(e, !1, i)) ? s : c[t];
                "string" == (r = typeof n) && (s = ne.exec(n)) && s[1] && (n = ce(e, t, s), r = "number"), null != n && n == n && ("number" !== r || l || (n += s && s[3] || (x.cssNumber[o] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var s, r, a, o = Y(t);
            return Ge.test(t) || (t = Ke(o)), (a = x.cssHooks[t] || x.cssHooks[o]) && "get" in a && (s = a.get(e, !0, n)), void 0 === s && (s = We(e, t, i)), "normal" === s && t in Je && (s = Je[t]), "" === n || n ? (r = parseFloat(s), !0 === n || isFinite(r) ? r || 0 : s) : s
        }
    }), x.each(["height", "width"], function(e, t) {
        x.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !Xe.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, t, i) : le(e, Ze, function() {
                    return tt(e, t, i)
                })
            },
            set: function(e, n, i) {
                var s, r = qe(e),
                    ...
                    o = (a || i) && "border-box" === x.css(e, "boxSizing", !1, r),
                    l = i ? et(e, t, i, o, r) : 0;
                return o && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - et(e, t, "border", !1, r) - .5)), l && (s = ne.exec(n)) && "px" !== (s[3] || "px") && (e.style[t] = n, n = x.css(e, t)), Qe(0, n, l)
            }
        }
        ...
        x.cssHooks[e + t] = {
            expand: function(n) {
                for (var i = 0, s = {}, r = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++) s[e + ie[i] + t] = r[i] || r[i - 2] || r[0];
                return s
            }
        ...
        css: function(e, t) {
            return W(this, function(e, t, n) {
                var i, s, r = {},
                    a = 0;
                if (Array.isArray(t)) {
                    for (i = qe(e), s = t.length; a < s; a++) r[t[a]] = x.css(e, t[a], !1, i);
                    return r
                }
        ...
        init: function(e, t, n, i, s, r) {
            this.elem = e, this.prop = n, this.easing = s || x.easing._default, this.options = t, this.start = this.now = this.cur(), this.end = i, this.unit = r || (x.cssNumber[n] ? "" : "px")
        },
        cur: function() {
    ...
    var it, st, rt, at, ot = /^(?:toggle|show|hide)$/,
        lt = /queueHooks$/;

    function ct() {
        st && (!1 === i.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(ct) : e.setTimeout(ct, x.fx.interval), x.fx.tick())
    }
    ...
    function pt(e, t, n) {
        for (var i, s = (ht.tweeners[t] || []).concat(ht.tweeners["*"]), r = 0, a = s.length; r < a; r++)
    ...
    function ht(e, t, n) {
        var i, s, r = 0,
            ...
            l = function() {
                if (s) return !1;
                for (var t = it || dt(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, a = c.tweens.length; r < a; r++) c.tweens[r].run(i);
        ...
        for (function(e, t) {
                var n, i, s, r, a;
                for (n in e)
                    if (s = t[i = Y(n)], r = e[n], Array.isArray(r) && (s = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (a = x.cssHooks[i]) && "expand" in a)
                        for (n in r = a.expand(r), delete e[i], r) n in e || (e[n] = r[n], t[n] = s);
                    else t[i] = s
            }(d, c.opts.specialEasing); r < a; r++)
            if (i = ht.prefilters[r].call(c, e, d, c.opts)) return m(i.stop) && (x._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return x.map(d, pt, c), m(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), x.fx.timer(x.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    x.Animation = x.extend(ht, {
        ...
        prefilters: [function(e, t, n) {
            var i, s, r, a, o, l, c, d, u = "width" in t || "height" in t,
                p = this,
                h = {},
                f = e.style,
                m = e.nodeType && oe(e),
            ...
            if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(h))
                for (i in u && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = g && g.display) && (c = G.get(e, "display")), "none" === (d = x.css(e, "display")) && (c ? d = c : (ue([e], !0), c = e.style.display || c, d = x.css(e, "display"), ue([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === x.css(e, "float") && (l || (p.done(function() {
                        f.display = c
                    ...
                    display: c
                }), r && (g.hidden = !m), m && ue([e], !0), p.done(function() {
                    for (i in m || ue([e]), G.remove(e, "fxshow"), h) x.style(e, i, h[i])
        ...
        stop: function(e, t, n) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function() {
                ...
                if (s) a[s] && a[s].stop && i(a[s]);
                    ...
                    for (s in a) a[s] && a[s].stop && lt.test(s) && i(a[s]);
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"), this.each(function() {
                var t, n = G.get(this),
                    ...
                    r = x.timers,
                    a = i ? i.length : 0;
                for (n.finish = !0, x.queue(this, e, []), s && s.stop && s.stop.call(this, !0), t = r.length; t--;) r[t].elem === this && r[t].queue === e && (r[t].anim.stop(!0), r.splice(t, 1));
    ...
    }, rt = i.createElement("input"), at = i.createElement("select").appendChild(i.createElement("option")), rt.type = "checkbox", f.checkOn = "" !== rt.value, f.optSelected = at.selected, (rt = i.createElement("input")).value = "t", rt.type = "radio", f.radioValue = "t" === rt.value;
    ...
    x.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? x.prop(e, t, n) : (1 === r && x.isXMLDoc(e) || (s = x.attrHooks[t.toLowerCase()] || (x.expr.match.bool.test(t) ? ft : void 0)), void 0 !== n ? null === n ? void x.removeAttr(e, t) : s && "set" in s && void 0 !== (i = s.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : s && "get" in s && null !== (i = s.get(e, t)) ? i : null == (i = x.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    x.fn.extend({
        ...
        prop: function(e, t, n) {
            var i, s, r = e.nodeType;
            if (3 !== r && 8 !== r && 2 !== r) return 1 === r && x.isXMLDoc(e) || (t = x.propFix[t] || t, s = x.propHooks[t]), void 0 !== n ? s && "set" in s && void 0 !== (i = s.set(e, n, t)) ? i : e[t] = n : s && "get" in s && null !== (i = s.get(e, t)) ? i : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : m(e) ? this.each(function(n) {
                ...
                var t, s, r, a;
                if (i)
                    for (s = 0, r = x(this), a = _t(e); t = a[s++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
    ...
    x.fn.extend({
        val: function(e) {
            ...
            })) : s ? (t = x.valHooks[s.type] || x.valHooks[s.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(s, "value")) ? n : "string" == typeof(n = s.value) ? n.replace(xt, "") : null == n ? "" : n : void 0
        }
    }), x.extend({
        valHooks: {
            option: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, i, s = e.options, r = x.makeArray(t), a = s.length; a--;)((i = s[a]).selected = -1 < x.inArray(x.valHooks.option.get(i), r)) && (n = !0);
    ...
    x.extend(x.event, {
        trigger: function(t, n, s, r) {
            var a, o, l, c, d, p, h, f, v = [s || i],
                y = u.call(t, "type") ? t.type : t,
                b = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = f = l = s = s || i, 3 !== s.nodeType && 8 !== s.nodeType && !wt.test(y + x.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), d = y.indexOf(":") < 0 && "on" + y, (t = t[x.expando] ? t : new x.Event(y, "object" == typeof t && t)).isTrigger = r ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = s), n = null == n ? [t] : x.makeArray(n, [t]), h = x.event.special[y] || {}, r || !h.trigger || !1 !== h.trigger.apply(s, n))) {
                if (!r && !h.noBubble && !g(s)) {
                    for (c = h.delegateType || y, wt.test(c + y) || (o = o.parentNode); o; o = o.parentNode) v.push(o), l = o;
                    l === (s.ownerDocument || i) && v.push(l.defaultView || l.parentWindow || e)
                }
                for (a = 0;
                    (o = v[a++]) && !t.isPropagationStopped();) f = o, t.type = 1 < a ? c : h.bindType || y, (p = (G.get(o, "events") || {})[t.type] && G.get(o, "handle")) && p.apply(o, n), (p = d && o[d]) && p.apply && K(o) && (t.result = p.apply(o, n), !1 === t.result && t.preventDefault());
                return t.type = y, r || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(v.pop(), n) || !K(s) || d && m(s[y]) && !g(s) && ((l = s[d]) && (s[d] = null), x.event.triggered = y, t.isPropagationStopped() && f.addEventListener(y, kt), s[y](), t.isPropagationStopped() && f.removeEventListener(y, kt), x.event.triggered = void 0, l && (s[d] = l)), t.result
            }
        },
        ...
        x.event.special[t] = {
            setup: function() {
                var i = this.ownerDocument || this,
                    s = G.access(i, t);
                s || i.addEventListener(e, n, !0), G.access(i, t, (s || 0) + 1)
            },
            teardown: function() {
                var i = this.ownerDocument || this,
                    s = G.access(i, t) - 1;
                s ? G.access(i, t, s) : (i.removeEventListener(e, n, !0), G.remove(i, t))
            }
        }
    });
    var Ct = e.location,
    ...
    function It(e, t, n, i) {
        ...
        if (Array.isArray(t)) x.each(t, function(t, s) {
            n || Tt.test(e) ? i(e, s) : It(e + "[" + ("object" == typeof s && null != s ? t : "") + "]", s, n, i)
        });
    ...
    x.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !x(this).is(":disabled") && Mt.test(this.nodeName) && !Et.test(e) && (this.checked || !pe.test(e))
            }).map(function(e, t) {
                var n = x(this).val();
    ...
    qt.href = Ct.href, x.extend({
        ...
        ajax: function(t, n) {
            ...
            var s, r, a, o, l, c, d, u, p, h, f = x.ajaxSetup({}, n),
                m = f.context || f,
                ...
                C = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (d) {
                            if (!o)
                                for (o = {}; t = jt.exec(a);) o[t[1].toLowerCase() + " "] = (o[t[1].toLowerCase() + " "] || []).concat(t[2]);
                            t = o[e.toLowerCase() + " "]
                        }
                    ...
                    setRequestHeader: function(e, t) {
                        return null == d && (e = w[e.toLowerCase()] = w[e.toLowerCase()] || e, _[e] = t), this
                    },
            ...
            if (v.promise(C), f.url = ((t || f.url || Ct.href) + "").replace(Ot, Ct.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(P) || [""], null == f.crossDomain) {
                c = i.createElement("a");
                try {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = x.param(f.data, f.traditional)), Wt(Lt, f, n, C), d) return C;
            for (p in (u = x.event && f.global) && 0 == x.active++ && x.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Pt.test(f.type), r = f.url.replace(At, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Nt, "+")) : (h = f.url.slice(r.length), f.data && (f.processData || "string" == typeof f.data) && (r += ($t.test(r) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (r = r.replace(Ht, "$1"), h = ($t.test(r) ? "&" : "?") + "_=" + Dt++ + h), f.url = r + h), f.ifModified && (x.lastModified[r] && C.setRequestHeader("If-Modified-Since", x.lastModified[r]), x.etag[r] && C.setRequestHeader("If-None-Match", x.etag[r])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && C.setRequestHeader("Content-Type", f.contentType), C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : f.accepts["*"]), f.headers) C.setRequestHeader(p, f.headers[p]);
            if (f.beforeSend && (!1 === f.beforeSend.call(m, C, f) || d)) return C.abort();
            if (k = "abort", y.add(f.complete), C.done(f.success), C.fail(f.error), s = Wt(Rt, f, n, C)) {
            ...
            function D(t, n, i, o) {
                var c, p, h, _, w, k = n;
                d || (d = !0, l && e.clearTimeout(l), s = void 0, a = o || "", C.readyState = 0 < t ? 4 : 0, c = 200 <= t && t < 300 || 304 === t, i && (_ = function(e, t, n) {
        ...
        x[t] = function(e, n, i, s) {
            return m(n) && (s = s || i, i = n, n = void 0), x.ajax(x.extend({
                url: e,
                type: t,
                dataType: s,
                data: n,
    ...
    f.cors = !!Ut && "withCredentials" in Ut, f.ajax = Ut = !!Ut, x.ajaxTransport(function(t) {
        var n, i;
        if (f.cors || Ut && !t.crossDomain) return {
            send: function(s, r) {
                ...
                n = function(e) {
                    return function() {
                        n && (n = i = o.onload = o.onerror = o.onabort = o.ontimeout = o.onreadystatechange = null, "abort" === e ? o.abort() : "error" === e ? "number" != typeof o.status ? r(0, "error") : r(o.status, o.statusText) : r(Vt[o.status] || o.status, o.statusText, "text" !== (o.responseType || "text") || "string" != typeof o.responseText ? {
                            binary: o.response
                        } : {
                            text: o.responseText
    ...
    x.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Kt.pop() || x.expando + "_" + Dt++;
            return this[e] = !0, e
        }
    }), x.ajaxPrefilter("json jsonp", function(t, n, i) {
        var s, r, a, o = !1 !== t.jsonp && (Xt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Xt.test(t.data) && "data");
        if (o || "jsonp" === t.dataTypes[0]) return s = t.jsonpCallback = m(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, o ? t[o] = t[o].replace(Xt, "$1" + s) : !1 !== t.jsonp && (t.url += ($t.test(t.url) ? "&" : "?") + t.jsonp + "=" + s), t.converters["script json"] = function() {
            return a || x.error(s + " was not called"), a[0]
        }, t.dataTypes[0] = "json", r = e[s], e[s] = function() {
            a = arguments
        }, i.always(function() {
            void 0 === r ? x(e).removeProp(s) : e[s] = r, t[s] && (t.jsonpCallback = n.jsonpCallback, Kt.push(s)), a && m(r) && r(a[0]), a = r = void 0
        }), "script"
    }), f.createHTMLDocument = ((Yt = i.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Yt.childNodes.length), x.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (f.createHTMLDocument ? ((s = (t = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, t.head.appendChild(s)) : t = i), a = !n && [], (r = E.exec(e)) ? [t.createElement(r[1])] : (r = xe([e], t, a), a && a.length && x(a).remove(), x.merge([], r.childNodes)));
        var s, r, a
    }, x.fn.load = function(e, t, n) {
        var i, s, r, a = this,
            o = e.indexOf(" ");
        return -1 < o && (i = yt(e.slice(o)), e = e.slice(0, o)), m(t) ? (n = t, t = void 0) : t && "object" == typeof t && (s = "POST"), 0 < a.length && x.ajax({
            url: e,
            type: s || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, s, r, a, o, l, c = x.css(e, "position"),
                d = x(e),
                u = {};
            "static" === c && (e.style.position = "relative"), o = d.offset(), r = x.css(e, "top"), l = x.css(e, "left"), ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (a = (i = d.position()).top, s = i.left) : (a = parseFloat(r) || 0, s = parseFloat(l) || 0), m(t) && (t = t.call(e, n, x.extend({}, o))), null != t.top && (u.top = t.top - o.top + a), null != t.left && (u.left = t.left - o.left + s), "using" in t ? t.using.call(e, u) : d.css(u)
        }
    }, x.fn.extend({
        offset: function(e) {
        ...
        x.fn[e] = function(i) {
            return W(this, function(e, i, s) {
                var r;
                if (g(e) ? r = e : 9 === e.nodeType && (r = e.defaultView), void 0 === s) return r ? r[t] : e[i];
                r ? r.scrollTo(n ? r.pageXOffset : s, n ? s : r.pageYOffset) : e[i] = s
            }, e, i, arguments.length)
        }
    }), x.each(["top", "left"], function(e, t) {
        x.cssHooks[t] = ze(f.pixelPosition, function(e, n) {
            if (n) return n = We(e, t), Fe.test(n) ? x(e).position()[t] + "px" : n
        })
    }), x.each({
        Height: "height",
        Width: "width"
        ...
        x.each({
            ...
            x.fn[i] = function(s, r) {
                ...
                return W(this, function(t, n, s) {
                    var r;
                    return g(t) ? 0 === i.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (r = t.documentElement, Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === s ? x.css(t, n, o) : x.style(t, n, s, o)
                }, t, a ? s : void 0, a)
            }
        })
        ...
        var n, i, s;
        if ("string" == typeof t && (n = e[t], t = e, e = n), m(e)) return i = r.call(arguments, 2), (s = function() {
            return e.apply(t || this, i.concat(r.call(arguments)))
        }).guid = e.guid = e.guid || x.guid++, s
    }, x.holdReady = function(e) {
        e ? x.readyWait++ : x.ready(!0)
    }, x.isArray = Array.isArray, x.parseJSON = JSON.parse, x.nodeName = S, x.isFunction = m, x.isWindow = g, x.camelCase = Y, x.type = b, x.now = Date.now, x.isNumeric = function(e) {
        var t = x.type(e);
...
function(e) {
    ...
    var t, n, i, s, r, a, o = "Close",
        ...
        x = function(t, n, i, s) {
            ...
            return r.className = "mfp-" + t, i && (r.innerHTML = i), s ? n && n.appendChild(r) : (r = e(r), n && r.appendTo(n)), r
        },
        w = function(n, i) {
    ...
    v.prototype = {
        ...
        open: function(n) {
            ...
            if (!1 === n.isObj) {
                ...
                for (s = 0; s < o.length; s++)
                    if ((a = o[s]).parsed && (a = a.el[0]), a === n.el[0]) {
                        t.index = s;
                        break
                    }
            ...
            if (!t.isOpen) {
                ...
                w("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (_(c, function(e, t, n, i) {
                ...
                }, 16), t.isOpen = !0, t.updateSize(p), w(d), n
            }
            t.updateItemHTML()
        },
        close: function() {
        ...
        updateItemHTML: function() {
            ...
            t.appendContent(a, i), n.preloaded = !0, w(u, n), s = n.type, t.container.prepend(t.contentContainer), w("AfterChange")
        },
        appendContent: function(e, n) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[n] ? t.content.find(".mfp-close").length || t.content.append(k()) : t.content = e : t.content = "", w("BeforeAppend"), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(n) {
            var i, s = t.items[n];
            if (s.tagName ? s = {
            ...
            return s.type = i || t.st.type || "inline", s.index = n, s.parsed = !0, t.items[n] = s, w("ElementParse", s), t.items[n]
        },
        ...
        updateStatus: function(e, i) {
            if (t.preloader) {
                ...
                w("UpdateStatus", s), e = s.status, i = s.text, t.preloader.html(i), t.preloader.find("a").on("click", function(e) {
                    e.stopImmediatePropagation()
        ...
        _parseMarkup: function(t, n, i) {
            var s;
            i.data && (n = e.extend(i.data, n)), w(c, [t, n, i]), e.each(n, function(n, i) {
                if (void 0 === i || !1 === i) return !0;
                if ((s = n.split("_")).length > 1) {
                    var r = t.find(h + "-" + s[0]);
                    if (r.length > 0) {
                        var a = s[1];
                        "replaceWith" === a ? r[0] !== i[0] && r.replaceWith(i) : "img" === a ? r.is("img") ? r.attr("src", i) : r.replaceWith(e("<img>").attr("src", i).attr("class", r.attr("class"))) : r.attr(s[1], i)
                    }
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                var s, r = y ? i.data("magnificPopup") : i[0].magnificPopup,
                    a = parseInt(arguments[1], 10) || 0;
                r.items ? s = r.items[a] : (s = i, r.delegate && (s = s.find(r.delegate)), s = s.eq(a)), t._openClick({
                    mfpEl: s
                }, i, r)
    ...
    var D, $, T, S = "inline",
        E = function() {
            T && ($.after(T.addClass(D)).detach(), T = null)
        };
            ...
            getInline: function(n, i) {
                if (E(), n.src) {
                    ...
                    if (r.length) {
                        ...
                        a && a.tagName && ($ || (D = s.hiddenClass, $ = x(D), D = "mfp-" + D), T = r.after($).detach().removeClass(D)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(I, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(I), M = t.st.ajax.cursor, _(o + "." + I, A), _("BeforeChange." + I, A)
            },
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, s, r) {
                        ...
                        w("ParseAjax", a), t.appendContent(e(a.data), I), n.finished = !0, N(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(f)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, H && clearInterval(H), e.isCheckingImgSize = !1, w("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
                ...
                var n = 0,
                    ...
                    s = function(r) {
                        H && clearInterval(H), H = setInterval(function() {
                            return i.naturalWidth > 0 ? void t._onImageHasSize(e) : (n > 200 && clearInterval(H), void(3 === ++n ? s(10) : 40 === n ? s(50) : 100 === n && s(500)))
                        }, r)
                    };
                s(1)
            },
            getImage: function(n, i) {
                var s = 0,
                    r = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, w("ImageLoadComplete")) : 200 > ++s ? setTimeout(r, 100) : a())
                    },
                    a = function() {
                ...
                }, n), t.resizeImage(), n.hasSize ? (H && clearInterval(H), n.loadError ? (i.addClass("mfp-loading"), t.updateStatus("error", o.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), t.updateStatus("ready")), i) : (t.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, i.addClass("mfp-loading"), t.findImageSize(n)), i)
            }
        }
    });
    var P;
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
                    ...
                    var s, r, a = n.duration,
                        c = function(e) {
                            var t = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
                                ...
                                r = "transition";
                            return s["-webkit-" + r] = s["-moz-" + r] = s["-o-" + r] = s[r] = i, t.css(s), t
                        },
                        d = function() {
            ...
            _getOffset: function(n) {
                ...
                return void 0 === P && (P = void 0 !== document.createElement("p").style.MozTransform), P ? o["-moz-transform"] = o.transform = "translate(" + s.left + "px," + s.top + "px)" : (o.left = s.left, o.top = s.top), o
            }
        }
    });
    var O = "iframe",
    ...
    e.magnificPopup.registerModule(O, {
        ...
        proto: {
            initIframe: function() {
                t.types.push(O), _("BeforeChange", function(e, t, n) {
                    t !== n && (t === O ? L() : n === O && L(!0))
                }), _(o + "." + O, function() {
                    L()
                })
            ...
            getIframe: function(n, i) {
                ...
                var a = {};
                return r.srcAction && (a[r.srcAction] = s), t._parseMarkup(i, a, n), t.updateStatus("ready"), i
            }
        }
    });
    var R = function(e) {
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var n = t.st.gallery,
                    s = ".mfp-gallery";
                return t.direction = !0, !(!n || !n.enabled) && (r += " mfp-gallery", _(d + s, function() {
                ...
                }), _(c + s, function(e, i, s, r) {
                    var a = t.items.length;
                    s.counter = a > 1 ? F(n.tCounter, r.index, a) : ""
...
function(e, t, n) {
    ...
    a = "datepicker", o = !1, l = {
            ...
            _buildDatepickersContainer: function() {
                o = !0, i.append('<div class="datepickers-container" id="datepickers-container"></div>'), s = t("#datepickers-container")
            },
            ...
            formatDate: function(e, t) {
                ...
                switch (this.opts.timepicker && this.timepicker && p && (d = o((n = this.timepicker._getValidHoursFromDate(t, p)).hours), u = n.hours, h = n.dayPeriod), !0) {
                    ...
                    case /aa/.test(i):
                        i = f(i, s("aa"), h);
                    case /AA/.test(i):
                        i = f(i, s("AA"), h.toUpperCase());
                    case /dd/.test(i):
                        i = f(i, s("dd"), c.fullDate);
                    case /d/.test(i):
                        i = f(i, s("d"), c.date);
                    case /DD/.test(i):
                        i = f(i, s("DD"), a.days[c.day]);
                    case /D/.test(i):
                        i = f(i, s("D"), a.daysShort[c.day]);
                    case /mm/.test(i):
                        i = f(i, s("mm"), c.fullMonth);
                    case /m/.test(i):
                        i = f(i, s("m"), c.month + 1);
                    case /MM/.test(i):
                        i = f(i, s("MM"), this.loc.months[c.month]);
                    case /M/.test(i):
                        i = f(i, s("M"), a.monthsShort[c.month]);
                    case /ii/.test(i):
                        i = f(i, s("ii"), c.fullMinutes);
                    case /i/.test(i):
                        i = f(i, s("i"), c.minutes);
                    case /hh/.test(i):
                        i = f(i, s("hh"), d);
                    ...
                    case /yyyy2/.test(i):
                        i = f(i, s("yyyy2"), l[1]);
                    case /yy/.test(i):
                        i = f(i, s("yy"), c.year.toString().slice(-2))
                }
                return i
            },
            ...
            selectDate: function(e) {
                ...
                if (Array.isArray(e)) e.forEach(function(e) {
                    ...
                    } else n.range ? 2 == s ? (t.selectedDates = [e], t.minRange = e, t.maxRange = "") : 1 == s ? (t.selectedDates.push(e), t.maxRange ? t.minRange = e : t.maxRange = e, r.bigger(t.maxRange, t.minRange) && (t.maxRange = t.minRange, t.minRange = e), t.selectedDates = [t.minRange, t.maxRange]) : (t.selectedDates = [e], t.minRange = e) : t.selectedDates = [e];
            ...
            removeDate: function(e) {
                var t = this.selectedDates,
                    n = this;
                if (e instanceof Date) return t.some(function(i, s) {
                    return r.isSame(i, e) ? (t.splice(s, 1), n.selectedDates.length ? n.lastSelectedDate = n.selectedDates[n.selectedDates.length - 1] : (n.minRange = "", n.maxRange = "", n.lastSelectedDate = ""), n.views[n.currentView]._render(), n._setInputValue(), n.opts.onSelect && n._triggerOnChange(), !0) : void 0
                })
            },
            today: function() {
            ...
            _isSelected: function(e, t) {
                ...
                return this.selectedDates.some(function(i) {
                    return r.isSame(i, e, t) ? (n = i, !0) : void 0
                }), n
            },
            _setInputValue: function() {
                ...
                n.altField && t.$altField.length && (e = (e = this.selectedDates.map(function(e) {
            ...
            _isInRange: function(e, t) {
                var n = e.getTime(),
                    ...
                    l = new Date(i.year, i.month, a.date).getTime(),
                    c = {
                        day: n >= this.minTime && n <= this.maxTime,
                        month: o >= this.minTime && l <= this.maxTime,
                        year: i.year >= s.year && i.year <= a.year
                    };
                return t ? c[t] : c.day
            },
            ...
            _getDateFromCell: function(e) {
                var t = this.parsedDate,
                    ...
                    s = e.data("month") == n ? t.month : e.data("month"),
                    r = e.data("date") || 1;
            ...
            setPosition: function(e) {
                ...
                switch (l) {
                    ...
                    case "right":
                        ...
                        break;
                    case "bottom":
                        t = i.top + i.height - s.height;
                        break;
                    case "left":
                        n = i.left;
                        break;
                    case "center":
                        /left|right/.test(o) ? t = i.top + i.height / 2 - s.height / 2 : n = i.left + i.width / 2 - s.width / 2
                }
                this.$datepicker.css({
                    left: n,
                    top: t
            ...
            _handleHotKey: function(e) {
                var t, n, i, s = r.getParsedDate(this._getFocusedDate()),
                    a = this.opts,
                    o = !1,
                    l = !1,
                    c = !1,
            ...
            _isHotKeyPressed: function() {
                var e, t = !1,
                    n = this.keys.sort();
                for (var i in c) e = c[i], n.length == e.length && e.every(function(e, t) {
                    return e == n[t]
            ...
            _focusNextCell: function(e, t) {
                t = t || this.cellType;
                var n = r.getParsedDate(this._getFocusedDate()),
                    i = n.year,
                    s = n.month,
                    a = n.date;
                if (!this._isHotKeyPressed()) {
                    switch (e) {
                        case 37:
                            "day" == t && (a -= 1), "month" == t && (s -= 1), "year" == t && (i -= 1);
                            break;
                        case 38:
                            "day" == t && (a -= 7), "month" == t && (s -= 3), "year" == t && (i -= 4);
                            break;
                        case 39:
                            "day" == t && (a += 1), "month" == t && (s += 1), "year" == t && (i += 1);
                            break;
            ...
            _getCell: function(e, n) {
                ...
                return (i = this.views[this.currentView].$el.find(a)).length ? i : t("")
            },
            destroy: function() {
                var e = this;
            ...
            _onMouseEnterCell: function(e) {
                ...
                this.silent = !0, this.focused && (this.focused = ""), n.addClass("-focus-"), this.focused = i, this.silent = !1, this.opts.range && 1 == this.selectedDates.length && (this.minRange = this.selectedDates[0], this.maxRange = "", r.less(this.minRange, this.focused) && (this.maxRange = this.minRange, this.minRange = ""), this.views[this.currentView]._update())
            },
            ...
            _onTimeChange: function(e, t, n) {
                var i = new Date,
                    s = !1;
                this.selectedDates.length && (s = !0, i = this.lastSelectedDate), i.setHours(t), i.setMinutes(n), s || this._getCell(i).hasClass("-disabled-") ? (this._setInputValue(), this.opts.onSelect && this._triggerOnChange()) : this.selectDate(i)
            },
        ...
        }, r.isSame = function(e, t, n) {
            if (!e || !t) return !1;
            var i = r.getParsedDate(e),
                s = r.getParsedDate(t),
                a = n || "day";
            return {
        ...
        }, r.less = function(e, t, n) {
            return !(!e || !t) && t.getTime() < e.getTime()
        }, r.bigger = function(e, t, n) {
            return !(!e || !t) && t.getTime() > e.getTime()
        }, r.getLeadingZeroNum = function(e) {
            return parseInt(e) < 10 ? "0" + e : e
        }, r.resetTime = function(e) {
            return "object" == typeof e ? (e = r.getParsedDate(e), new Date(e.year, e.month, e.date)) : void 0
        }, t.fn.datepicker = function(e) {
            return this.each(function() {
                if (t.data(this, a)) {
                    var n = t.data(this, a);
                    n.opts = t.extend(!0, n.opts, e), n.update()
                } else t.data(this, a, new d(this, e))
            })
        }, t.fn.datepicker.Constructor = d, t.fn.datepicker.language = {
            ru: {
        ...
        function() {
            ...
            i.Body = function(e, n, i) {
                ...
                _getDayNamesHtml: function(e, t, i, s) {
                    return t = t != n ? t : e, i = i || "", (s = s != n ? s : 0) > 7 ? i : 7 == t ? this._getDayNamesHtml(e, 0, i, ++s) : (i += '<div class="datepicker--day-name' + (this.d.isWeekend(t) ? " -weekend-" : "") + '">' + this.d.loc.daysMin[t] + "</div>", this._getDayNamesHtml(e, ++t, i, ++s))
                },
                _getCellContents: function(e, t) {
                    ...
                    switch (t) {
                        case "day":
                            r.isWeekend(c.day) && (n += " -weekend-"), c.month != this.d.parsedDate.month && (n += " -other-month-", l.selectOtherMonths || (n += " -disabled-"), l.showOtherMonths || (u = ""));
                            break;
                        case "month":
                ...
                _getDaysHtml: function(e) {
                    for (var t, n, i = s.getDaysCount(e), r = new Date(e.getFullYear(), e.getMonth(), 1).getDay(), a = new Date(e.getFullYear(), e.getMonth(), i).getDay(), o = r - this.d.loc.firstDay, l = 6 - a + this.d.loc.firstDay, c = "", d = 1 - (o = 0 > o ? o + 7 : o), u = i + (l = l > 6 ? l - 7 : l); u >= d; d++) n = e.getFullYear(), t = e.getMonth(), c += this._getDayHtml(new Date(n, t, d));
                    return c
                },
                ...
                _getMonthsHtml: function(e) {
                    for (var t = "", n = s.getParsedDate(e), i = 0; 12 > i;) t += this._getMonthHtml(new Date(n.year, i)), i++;
                    return t
                },
                ...
                _getYearsHtml: function(e) {
                    for (var t = (s.getParsedDate(e), s.getDecade(e)), n = "", i = t[0] - 1; i <= t[1] + 1; i++) n += this._getYearHtml(new Date(i, 0));
                    return n
                },
                ...
                _update: function() {
                    var e, n, i, s = t(".datepicker--cell", this.$cells),
                        r = this;
                    s.each(function(s, a) {
                        n = t(this), i = r.d._getDateFromCell(t(this)), e = r._getCellContents(i, r.d.cellType), n.attr("class", e.classes)
                    })
                },
                show: function() {
                ...
                _handleClick: function(e) {
                    ...
                    if (s.view == this.opts.minView) {
                        ...
                        return a ? void s._handleAlreadySelectedDates.bind(s, a, r)() : void s._trigger("clickCell", r)
                    }
                    s.down(new Date(i, n, t))
                },
            ...
            e.Navigation = function(e, t) {
                ...
                _addButton: function(e) {
                    ...
                    var i = {
                        ...
                        s = n.template('<span class="datepicker--button" data-action="#{action}">#{label}</span>', i);
                ...
                _onClickNavButton: function(e) {
                    var n = t(e.target).closest("[data-action]").data("action");
                    this.d[n]()
                },
    ...
    $(".add-user__js").click(function() {
        $(this).addClass("current"), $(this).next().removeClass("current"), 0 !== $("[data-block_img=" + $(this).attr("data_el") + "]").find("[id*=img_block_" + $(this).attr("data_el")).length && "-1" != $("#time_" + $(this).attr("data_el")).text().search("2") ? ($("#send_" + id).attr("onclick", "send_ms(this)"), $("#send_" + id).removeClass("disabled")) : $("#send_" + $(this).attr("data_el")).addClass("disabled")
    }), $(".add-child__js").click(function() {
        $(this).addClass("current"), $(this).prev().removeClass("current"), 0 !== $("[data-block_img=" + $(this).attr("data_el") + "]").find("[id*=img_block_" + $(this).attr("data_el")).length && "-1" != $("#time_" + $(this).attr("data_el")).text().search("2") && "" !== $("#children_input_" + $(this).attr("data_el")).attr("data-id_child") ? ($("#send_" + id).attr("onclick", "send_ms(this)"), $("#send_" + id).removeClass("disabled")) : $("#send_" + $(this).attr("data_el")).addClass("disabled")
    }), $("[class *=datepicker-here_obrashcheniya]").each(function() {
        var e = $(this).attr("data-date");
        $(this).datepicker({
            minDate: new Date(e + "-01-01T00:00:01"),
            maxDate: new Date(e + "-12-31T23:59:59")
        })
    }), $(".block__items_flex").each(function() {
        var e = $(this),
            t = e.attr("data-block_img");
        0 === e.children().length ? ($("#send_" + t).removeAttr("onclick"), $("#send_" + t).addClass("disabled")) : void 0 === $("[data-pdf-id=" + t + "]").find(".pdf").attr("href") && ($("#send_" + t).removeAttr("onclick"), $("#send_" + t).addClass("disabled"))
    })
}), addChild(), $("input[type='file']").click(function() {
    $(this).addClass("click")
}), $("input[type='file']").change(function() {
    if (!0 === $(this).hasClass("click")) {
        let e = this.id;
        (new FileReader).readAsDataURL(this.files[0]);
        let t = $(this),
            n = new FormData;
        n.append("import_file", t.prop("files")[0]), n.append("id_elem", e);
        let i = $("#card_" + e),
            s = $("#error_" + e),
            r = $("#success_" + e);
        i.find($(".js-img-add")).children().length < 5 ? $.ajax({
            ...
            type: "post",
            success: function(t) {
                let n, a = JSON.parse(t);
                if (void 0 !== a.ERROR) s.text(a.ERROR), r.text("");
                else if (!1 === a.RES) s.text("Не удается прочитать файл"), r.text("");
                else {
                    s.text(""), r.text(a.SUCCESS);
                    let t = a.SRC.toLowerCase();
 let k = a.FILE_NAME.toLowerCase();
//alert(k);
                    n = "-1" != t.search(".pdf") ? "/local/templates/kdteam/images/svg/pdf_icon.svg" : t, i.find($(".js-img-add")).append('<div id="img_block_' + a.ID + '" class="obrashcheniya__content_sidebar_blocks">\n    <div class="obrashcheniya__content_sidebar_blocks_img">\n        <img src="' + n + '">\n    </div>\n    <div class="obrashcheniya__content_sidebar_blocks_text">\n        <div class="obrashcheniya__content_sidebar_blocks_text_title">' + k + '</div>\n        <a id="download_img" download href="' + t + '"\n           class="obrashcheniya__content_sidebar_blocks_text_link">скачать</a>\n        <a href="#" rel="nofollow" onclick="del(this)" id="delete_' + a.ID + '" class="delete_img_js">удалить</a>\n    </div>\n</div>'), $(".photo_empty_all_" + e).html(""), "0" !== $("[data-block_img=" + e + "]").find("[id=img_block_" + e).length && "-1" != $("#time_" + e).text().search("2") && ($("#send_" + e).attr("onclick", "send_ms(this)"), $("#send_" + e).removeClass("disabled"))
                }
            }
        }) : (s.text("Вы превысили лимит по загруженным картинкам"), r.text(""))
    }
}), $(document).on("click", ".children_input", function() {
    let e = $(this).attr("data-value");
    search(e), $("#searchul_" + e).css("display", "block")
});