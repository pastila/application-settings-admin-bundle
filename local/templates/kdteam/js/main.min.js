function responseMessage(e) {
    $(".success-box").fadeIn(200), $(".success-box").addClass("active"), $(".success-box div.text-message").html("<span>" + e + "</span>")
}
...
function lazyloadImage() {
    const e = document.querySelectorAll("[data-src]"),
        t = document.querySelectorAll("[data-srcset]");
    const n = new IntersectionObserver(function(e, t) {
        e.forEach(e => {
            e.isIntersecting && (e.target.classList.remove("lazy-kdteam"), function(e) {
                const t = e.getAttribute("data-src"),
                    n = e.getAttribute("data-srcset");
                t || (e.srcset = n), e.src = t
...
function validatePassword() {
    let e = document.getElementById("pass_conf").value;
    document.getElementById("password").value != e ? document.getElementById("pass_conf").setCustomValidity("Пароли не совпадают") : document.getElementById("pass_conf").setCustomValidity("")
}
...
function form_us() {
    $("#feedback_modal").validator().on("submit", function(e) {
        ...
        return null != r.prop("files")[0] && t.append("import_file1", r.prop("files")[0]), null != r.prop("files")[1] && t.append("import_file2", r.prop("files")[1]), null != r.prop("files")[2] && t.append("import_file3", r.prop("files")[2]), null != r.prop("files")[3] && t.append("import_file4", r.prop("files")[3]), null != r.prop("files")[4] && t.append("import_file5", r.prop("files")[4]), null != r.prop("files")[5] && ($(".file_input_half").after('<p class="label danger"  >Максимально 5 картинок</p>'), n.push("mane_img")), t.append("name", i[0].value), t.append("email", i[1].value), t.append("text", i[2].value), t.append("captcha_code", i[3].value), t.append("captcha_word", i[4].value), "0" == n.length && $.ajax({
            ...
            success: function(e) {
                var t = JSON.parse(e);
                "1" == t.suc ? $.magnificPopup.open({
                    items: {
                        src: '<div class="white-popup custom_styles_popup"><button title="Закрыть" type="button" class="mfp-close">×</button><h3 class="popup__wrap_tabs_title">Ваше письмо отправлено успешно</h3></div>',
                        type: "inline"
                    },
                    callbacks: {
                        afterClose: function() {
                ...
                }) : "1" == t.captcha ? $("#captcha-error_parent").after('<p class="label danger"  >Код капчи неверный</p>') : ("1" == t.size && $(".file_input_half").after('<p class="label danger"  >Файлы с недопустимым размером</p>'), "1" == t.format && $(".file_input_half").after('<p class="label danger"  >Файлы с недопустимым форматом</p>'))
            }
        }).done(function(e) {}), !1
    })
}
...
function form_us_two() {
    $("#feedback_modal_two").validator().on("submit", function(e) {
        ...
        var t = new FormData,
            n = [],
            i = $("#feedback_modal_two").serializeArray(),
            r = $(".file-simple");
        return null != r.prop("files")[0] && t.append("import_file1", r.prop("files")[0]), null != r.prop("files")[1] && t.append("import_file2", r.prop("files")[1]), null != r.prop("files")[2] && t.append("import_file3", r.prop("files")[2]), null != r.prop("files")[3] && t.append("import_file4", r.prop("files")[3]), null != r.prop("files")[4] && t.append("import_file5", r.prop("files")[4]), null != r.prop("files")[5] && ($(".file_input_half").after('<p class="label danger"  >Максимально 5 картинок</p>'), n.push("mane_img")), t.append("name", i[0].value), t.append("email", i[1].value), t.append("text", i[2].value), t.append("captcha_code", i[3].value), t.append("captcha_word", i[4].value), "0" == n.length && $.ajax({
            url: "/ajax/form_ask/ask.php",
            type: "POST",
...
function setCookie(e, t, n = {}) {
    ...
    function y(e, t, n) {
        ...
        if (s.text = e, t)
            for (r in v)(a = t[r] || t.getAttribute && t.getAttribute(r)) && s.setAttribute(r, a);
    ...
    _.fn = _.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[o] || {}, o++), "object" == typeof s || m(s) || (s = {}), o === l && (s = this, o--); o < l; o++)
            if (null != (e = arguments[o]))
                for (t in e) i = e[t], "__proto__" !== t && s !== i && (c && i && (_.isPlainObject(i) || (r = Array.isArray(i))) ? (n = s[t], a = r && !Array.isArray(n) ? [] : r || _.isPlainObject(n) ? n : {}, r = !1, s[t] = _.extend(c, a, i)) : void 0 !== i && (s[t] = i));
        return s
    }, _.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== u.call(e) || (t = r(e)) && ("function" != typeof(n = d.call(t, "constructor") && t.constructor) || p.call(n) !== h))
        },
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (k(Object(e)) ? _.merge(n, "string" == typeof e ? [e] : e) : o.call(n, e)), n
        },
    ...
    var C = function(e) {
        var t, n, i, r, a, s, o, l, c, u, d, p, h, f, m, g, v, y, b, x = "sizzle" + 1 * new Date,
            _ = e.document,
            w = 0,
            k = 0,
            C = le(),
        ...
        try {
            j.apply(E = N.call(_.childNodes), _.childNodes), E[_.childNodes.length].nodeType
        } catch (t) {
            j = {
        ...
        function oe(e, t, i, r) {
            var a, o, c, u, d, f, v, y = t && t.ownerDocument,
                w = t ? t.nodeType : 9;
            if (i = i || [], "string" != typeof e || !e || 1 !== w && 9 !== w && 11 !== w) return i;
            if (!r && ((t ? t.ownerDocument || t : _) !== h && p(t), t = t || h, m)) {
                if (11 !== w && (d = J.exec(e)))
                    if (a = d[1]) {
                        if (9 === w) {
                        ...
                        if ((a = d[3]) && n.getElementsByClassName && t.getElementsByClassName) return j.apply(i, t.getElementsByClassName(a)), i
                    }
                if (n.qsa && !$[e + " "] && (!g || !g.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    if (v = e, y = t, 1 === w && V.test(e)) {
                        for ((u = t.getAttribute("id")) ? u = u.replace(ie, re) : t.setAttribute("id", u = x), o = (f = s(e)).length; o--;) f[o] = "#" + u + " " + be(f[o]);
        ...
        for (t in n = oe.support = {}, a = oe.isXML = function(e) {
                ...
                return s !== h && 9 === s.nodeType && s.documentElement && (f = (h = s).documentElement, m = !a(h), _ !== h && (r = h.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", ae, !1) : r.attachEvent && r.attachEvent("onunload", ae)), n.attributes = ue(function(e) {
                    ...
                    return i || (1 & (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === i ? e === h || e.ownerDocument === _ && b(_, e) ? -1 : t === h || t.ownerDocument === _ && b(_, t) ? 1 : u ? P(u, e) - P(u, t) : 0 : 4 & i ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return d = !0, 0;
                    var n, i = 0,
                        r = e.parentNode,
                        ...
                        s = [e],
                        o = [t];
                    if (!r || !a) return e === h ? -1 : t === h ? 1 : r ? -1 : a ? 1 : u ? P(u, e) - P(u, t) : 0;
                    if (r === a) return pe(e, t);
                    for (n = e; n = n.parentNode;) s.unshift(n);
                    for (n = t; n = n.parentNode;) o.unshift(n);
                    for (; s[i] === o[i];) i++;
                    return i ? pe(s[i], o[i]) : s[i] === _ ? -1 : o[i] === _ ? 1 : 0
                }), h
            }, oe.matches = function(e, t) {
                return oe(e, null, null, t)
            }, oe.matchesSelector = function(e, t) {
                if ((e.ownerDocument || e) !== h && p(e), n.matchesSelector && m && !$[t + " "] && (!v || !v.test(t)) && (!g || !g.test(t))) try {
                    var i = y.call(e, t);
                ...
                filter: {
                    ...
                    CHILD: function(e, t, n, i, r) {
                        ...
                        return 1 === i && 0 === r ? function(e) {
                            ...
                            var c, u, d, p, h, f, m = a !== s ? "nextSibling" : "previousSibling",
                                g = t.parentNode,
                            ...
                            if (g) {
                                ...
                                if (f = [s ? g.firstChild : g.lastChild], s && y) {
                                    for (b = (h = (c = (u = (d = (p = g)[x] || (p[x] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === w && c[1]) && c[2], p = h && g.childNodes[h]; p = ++h && p && p[m] || (b = h = 0) || f.pop();)
                                        if (1 === p.nodeType && ++b && p === t) {
                                            u[e] = [w, h, b];
                                            break
                                        }
                                } else if (y && (b = h = (c = (u = (d = (p = t)[x] || (p[x] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === w && c[1]), !1 === b)
                                    for (;
                                        (p = ++h && p && p[m] || (b = h = 0) || f.pop()) && ((o ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && ((u = (d = p[x] || (p[x] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] = [w, b]), p !== t)););
                    ...
                    PSEUDO: function(e, t) {
                        ...
                        return r[x] ? r(t) : 1 < r.length ? (n = [e, e, "", t], i.setFilters.hasOwnProperty(e.toLowerCase()) ? ce(function(e, n) {
                            for (var i, a = r(e, t), s = a.length; s--;) e[i = P(e, a[s])] = !(n[i] = a[s])
                        }) : function(e) {
                            return r(e, 0, n)
                        }) : r
                    }
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || s)
                            if (u = (d = t[x] || (t[x] = {}))[t.uniqueID] || (d[t.uniqueID] = {}), r && r === t.nodeName.toLowerCase()) t = t[i] || t;
                                ...
                                if ((c = u[a]) && c[0] === w && c[1] === o) return p[2] = c[2];
        ...
        function ke(e, t, n, i, r, a) {
            return i && !i[x] && (i = ke(i)), r && !r[x] && (r = ke(r, a)), ce(function(a, s, o, l) {
                var c, u, d, p = [],
                    h = [],
                    f = s.length,
                    m = a || function(e, t, n) {
                    ...
                    g = !e || !a && t ? m : we(m, p, e, o, l),
                    v = n ? r || (a ? e : f || i) ? [] : s : g;
                if (n && n(g, v, o, l), i)
                    for (c = we(v, h), i(c, [], o, l), u = c.length; u--;)(d = c[u]) && (v[h[u]] = !(g[h[u]] = d));
                if (a) {
                    if (r || e) {
                        if (r) {
                        ...
                        for (u = v.length; u--;)(d = v[u]) && -1 < (c = r ? P(a, d) : p[u]) && (a[c] = !(s[c] = d))
                    }
                } else v = we(v === s ? v.splice(f, v.length) : v), r ? r(null, s, v, l) : j.apply(s, v)
            })
        }

        function Ce(e) {
            for (var t, n, r, a = e.length, s = i.relative[e[0].type], o = s || i.relative[" "], l = s ? 1 : 0, u = xe(function(e) {
                    return e === t
                }, o, !0), d = xe(function(e) {
                    return -1 < P(t, e)
                ...
                if (n = i.relative[e[l].type]) p = [xe(_e(p), n)];
                    ...
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[x]) {
                        ...
                        return ke(1 < l && _e(p), 1 < l && be(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(B, "$1"), n, l < r && Ce(e.slice(l, r)), r < a && Ce(e = e.slice(r)), r < a && be(e))
                    }
                    p.push(n)
                }
            return _e(p)
        ...
        return ye.prototype = i.filters = i.pseudos, i.setFilters = new ye, s = oe.tokenize = function(e, t) {
            var n, r, a, s, o, l, c, u = D[e + " "];
            if (u) return t ? 0 : u.slice(0);
            for (o = e, l = [], c = i.preFilter; o;) {
                for (s in n && !(r = z.exec(o)) || (r && (o = o.slice(r[0].length) || o), l.push(a = [])), n = !1, (r = W.exec(o)) && (n = r.shift(), a.push({
                        value: n,
                        type: r[0].replace(B, " ")
                    }), o = o.slice(n.length)), i.filter) !(r = K[s].exec(o)) || c[s] && !(r = c[s](r)) || (n = r.shift(), a.push({
                    value: n,
                    type: s,
                    matches: r
                }), o = o.slice(n.length));
            ...
            var n, r, a, o, l, u, d = [],
                ...
                g = T[e + " "];
            if (!g) {
                for (t || (t = s(e)), n = t.length; n--;)(g = Ce(t[n]))[x] ? d.push(g) : f.push(g);
                (g = T(e, (r = f, o = 0 < (a = d).length, l = 0 < r.length, u = function(e, t, n, s, u) {
                    var d, f, g, v = 0,
                        y = "0",
                        b = e && [],
                        x = [],
                        ...
                        D = k.length;
                    for (u && (c = t === h || t || u); y !== D && null != (d = k[y]); y++) {
                        if (l && d) {
                            for (f = 0, t || d.ownerDocument === h || (p(d), n = !m); g = r[f++];)
                                if (g(d, t || h, n)) {
                                    s.push(d);
                                    break
                                }
                    ...
                    if (v += y, o && y !== v) {
                        for (f = 0; g = a[f++];) g(b, x, t, n);
                        if (e) {
                            if (0 < v)
                                for (; y--;) b[y] || x[y] || (x[y] = I.call(s));
                            x = we(x)
                        }
                        j.apply(s, x), u && !e && 0 < x.length && 1 < v + a.length && oe.uniqueSort(s)
                    }
                    return u && (w = C, c = _), b
                }, o ? ce(u) : u))).selector = e
            }
            ...
            if (n = n || [], 1 === h.length) {
                ...
                for (a = K.needsContext.test(e) ? 0 : l.length; a-- && (c = l[a], !i.relative[u = c.type]);)
                    if ((d = i.find[u]) && (r = d(c.matches[0].replace(te, ne), ee.test(l[0].type) && ve(t.parentNode) || t))) {
                        if (l.splice(a, 1), !(e = r.length && be(l))) return j.apply(n, r), n;
                        break
                    }
            }
            return (p || o(e, h))(r, t, !m, n, !t || ee.test(e) && ve(t.parentNode) || t), n
    ...
    _.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!E(this, "string" == typeof e && $.test(e) ? _(e) : e || [], !1).length
        }
    });
    var I, A = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (_.fn.init = function(e, t, n) {
        ...
        if (n = n || I, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof _ ? t[0] : t, _.merge(this, _.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : i, !0)), M.test(r[1]) && _.isPlainObject(t))
    ...
    _.fn.extend({
        ...
        contents: function(e) {
            return void 0 !== e.contentDocument ? e.contentDocument : (S(e, "template") && (e = e.content || e), _.merge([], e.childNodes))
        }
    }, function(e, t) {
        _.fn[e] = function(n, i) {
            var r = _.map(this, t, n);
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = _.filter(i, r)), 1 < this.length && (N[e] || _.uniqueSort(r), j.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var H = /[^\x20\t\r\n\f]+/g;
    ...
    _.Callbacks = function(e) {
        ...
        var i, r, a, s, o = [],
            ...
            d = {
                add: function() {
                    return o && (r && !i && (c = o.length - 1, l.push(r)), function t(n) {
                        _.each(n, function(n, i) {
                            m(i) ? e.unique && d.has(i) || o.push(i) : i && i.length && "string" !== b(i) && t(i)
                        })
                    }(arguments), r && !i && u()), this
                },
                remove: function() {
                    return _.each(arguments, function(e, t) {
                        for (var n; - 1 < (n = _.inArray(t, o, n));) o.splice(n, 1), n <= c && c--
                    }), this
                },
                has: function(e) {
                ...
                r = {
                    ...
                    then: function(t, i, r) {
                                ...
                                var o = this,
                                    ...
                                    c = function() {
                                        ...
                                        if (!(t < a)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, m(c) ? r ? c.call(e, s(a, n, O, r), s(a, n, R, r)) : (a++, c.call(e, s(a, n, O, r), s(a, n, R, r), s(a, n, O, n.notifyWith))) : (i !== O && (o = void 0, l = [e]), (r || n.resolveWith)(o, l))
                                        }
                                    },
                                    u = r ? c : function() {
                                        try {
                                            ...
                                            _.Deferred.exceptionHook && _.Deferred.exceptionHook(e, u.stackTrace), a <= t + 1 && (i !== R && (o = void 0, l = [e]), n.rejectWith(o, l))
                                        }
                                    };
                        ...
                        return _.Deferred(function(e) {
                            n[0][3].add(s(0, e, m(r) ? r : O, e.notifyWith)), n[1][3].add(s(0, e, m(t) ? t : O)), n[2][3].add(s(0, e, m(i) ? i : R))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            ...
            if (t <= 1 && (L(e, s.done(o(n)).resolve, s.reject, !t), "pending" === s.state() || m(r[n] && r[n].then))) return s.then();
            for (; n--;) L(r[n], o(n), s.reject);
            return s.promise()
        }
    });
    ...
    _.fn.ready = function(e) {
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --_.readyWait : _.isReady) || (_.isReady = !0) !== e && 0 < --_.readyWait || q.resolveWith(i, [_])
        }
    }), _.ready.then = q.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(_.ready) : (i.addEventListener("DOMContentLoaded", B), e.addEventListener("load", B));
    var z = function(e, t, n, i, r, a, s) {
            var o = 0,
                l = e.length,
                c = null == n;
            if ("object" === b(n))
                for (o in r = !0, n) z(e, t, o, n[o], !0, a, s);
    ...
    _.extend({
        ...
        data: function(e, t) {
            var n, i, r, a = this[0],
                s = a && a.attributes;
            if (void 0 === e) {
                if (this.length && (r = Z.get(a), 1 === a.nodeType && !X.get(a, "hasDataAttrs"))) {
                    for (n = s.length; n--;) s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = Y(i.slice(5)), ee(a, i, r[i]));
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n;
                if (a && void 0 === t) return void 0 !== (n = Z.get(a, e)) ? n : void 0 !== (n = ee(a, e)) ? n : void 0;
                this.each(function() {
                    Z.set(this, e, t)
                })
        ...
        promise: function(e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;)(n = X.get(a[s], e + "queueHooks")) && n.empty && (i++, n.empty.add(o));
    ...
    function de(e, t) {
        for (var n, i, r, a, s, o, l, c = [], u = 0, d = e.length; u < d; u++)(i = e[u]).style && (n = i.style.display, t ? ("none" === n && (c[u] = X.get(i, "display") || null, c[u] || (i.style.display = "")), "" === i.style.display && oe(i) && (c[u] = (l = s = a = void 0, s = (r = i).ownerDocument, o = r.nodeName, (l = ue[o]) || (a = s.body.appendChild(s.createElement(o)), l = _.css(a, "display"), a.parentNode.removeChild(a), "none" === l && (l = "block"), ue[o] = l)))) : "none" !== n && (c[u] = "none", X.set(i, "display", n)));
    ...
    function ge(e, t) {
        var n;
        return n = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(t || "*") : [], void 0 === t || t && S(e, t) ? _.merge([e], n) : n
    }
    ...
    function _e(e, t, n, i, r) {
        for (var a, s, o, l, c, u, d = t.createDocumentFragment(), p = [], h = 0, f = e.length; h < f; h++)
            if ((a = e[h]) || 0 === a)
                if ("object" === b(a)) _.merge(p, a.nodeType ? [a] : a);
                else if (xe.test(a)) {
            for (s = s || d.appendChild(t.createElement("div")), o = (he.exec(a) || ["", ""])[1].toLowerCase(), l = me[o] || me._default, s.innerHTML = l[1] + _.htmlPrefilter(a) + l[2], u = l[0]; u--;) s = s.lastChild;
            _.merge(p, s.childNodes), (s = d.firstChild).textContent = ""
        } else p.push(t.createTextNode(a));
        for (d.textContent = "", h = 0; a = p[h++];)
            if (i && -1 < _.inArray(a, i)) r && r.push(a);
            else if (c = ae(a), s = ge(d.appendChild(a), "script"), c && ve(s), n)
            for (u = 0; a = s[u++];) fe.test(a.type || "") && n.push(a);
        return d
    }
        ...
        n ? (X.set(e, t, !1), _.event.add(e, t, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    else if (s = a.call(arguments), X.set(this, t, s), i = n(this, t), this[t](), s !== (r = X.get(this, t)) || i ? X.set(this, t, !1) : r = {}, s !== r) return e.stopImmediatePropagation(), e.preventDefault(), r.value
    ...
    _.event = {
        ...
        add: function(e, t, n, i, r) {
            var a, s, o, l, c, u, d, p, h, f, m, g = X.get(e);
            if (g)
                for (n.handler && (n = (a = n).handler, r = a.selector), r && _.find.matchesSelector(re, r), n.guid || (n.guid = _.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(t) {
                        return void 0 !== _ && _.event.triggered !== t.type ? _.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(H) || [""]).length; c--;) h = m = (o = Ce.exec(t[c]) || [])[1], f = (o[2] || "").split(".").sort(), h && (d = _.event.special[h] || {}, h = (r ? d.delegateType : d.bindType) || h, d = _.event.special[h] || {}, u = _.extend({
                    type: h,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, a), (p = l[h]) || ((p = l[h] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, f, s) || e.addEventListener && e.addEventListener(h, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, u) : p.push(u), _.event.global[h] = !0)
        },
        remove: function(e, t, n, i, r) {
            var a, s, o, l, c, u, d, p, h, f, m, g = X.hasData(e) && X.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(H) || [""]).length; c--;)
                    if (h = m = (o = Ce.exec(t[c]) || [])[1], f = (o[2] || "").split(".").sort(), h) {
                        for (d = _.event.special[h] || {}, p = l[h = (i ? d.delegateType : d.bindType) || h] || [], o = o[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = a = p.length; a--;) u = p[a], !r && m !== u.origType || n && n.guid !== u.guid || o && !o.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(a, 1), u.selector && p.delegateCount--, d.remove && d.remove.call(e, u));
                        s && !p.length && (d.teardown && !1 !== d.teardown.call(e, f, g.handle) || _.removeEvent(e, h, g.handle), delete l[h])
                    } else
        ...
        dispatch: function(e) {
            var t, n, i, r, a, s, o = _.event.fix(e),
                l = new Array(arguments.length),
                c = (X.get(this, "events") || {})[o.type] || [],
                u = _.event.special[o.type] || {};
            for (l[0] = o, t = 1; t < arguments.length; t++) l[t] = arguments[t];
            if (o.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, o)) {
                for (s = _.event.handlers.call(this, o, c), t = 0;
                    (r = s[t++]) && !o.isPropagationStopped();)
                    for (o.currentTarget = r.elem, n = 0;
                        (a = r.handlers[n++]) && !o.isImmediatePropagationStopped();) o.rnamespace && !1 !== a.namespace && !o.rnamespace.test(a.namespace) || (o.handleObj = a, o.data = a.data, void 0 !== (i = ((_.event.special[a.origType] || {}).handle || a.handler).apply(r.elem, l)) && !1 === (o.result = i) && (o.preventDefault(), o.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && 1 <= e.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (a = [], s = {}, n = 0; n < l; n++) void 0 === s[r = (i = t[n]).selector + " "] && (s[r] = i.needsContext ? -1 < _(r, this).index(c) : _.find(r, this, null, [c]).length), s[r] && a.push(i);
                        a.length && o.push({
                            elem: c,
                            handlers: a
                        })
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && S(t, "input") && Me(t, "click", De), !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && S(t, "input") && Me(t, "click"), !0
                },
                _default: function(e) {
                    var t = e.target;
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? De : Te, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && _.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[_.expando] = !0
    }, _.Event.prototype = {
        constructor: _.Event,
    ...
    function Oe(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Z.hasData(e) && (o = Z.access(e), l = _.extend({}, o), Z.set(t, l))
        }
    }
    ...
    function Re(e, t, n, i) {
        ...
        var r, a, o, l, c, u, d = 0,
            ...
            g = t[0],
            v = m(g);
        if (v || 1 < p && "string" == typeof g && !f.checkClone && Ae.test(g)) return e.each(function(r) {
            var a = e.eq(r);
            v && (t[0] = g.call(this, r, a.html())), Re(a, t, n, i)
        });
        if (p && (a = (r = _e(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = a), a || i)) {
            for (l = (o = _.map(ge(r, "script"), Pe)).length; d < p; d++) c = r, d !== h && (c = _.clone(c, !0, !0), l && _.merge(o, ge(c, "script"))), n.call(e[d], c, d);
            if (l)
                for (u = o[o.length - 1].ownerDocument, _.map(o, He), d = 0; d < l; d++) c = o[d], fe.test(c.type || "") && !X.access(c, "globalEval") && _.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? _._evalUrl && !c.noModule && _._evalUrl(c.src, {
    ...
    function Le(e, t, n) {
        for (var i, r = t ? _.filter(t, e) : e, a = 0; null != (i = r[a]); a++) n || 1 !== i.nodeType || _.cleanData(ge(i)), i.parentNode && (n && ae(i) && ve(ge(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    _.extend({
        ...
        clone: function(e, t, n) {
            var i, r, a, s, o, l, c, u = e.cloneNode(!0),
                d = ae(e);
            if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || _.isXMLDoc(e)))
                for (s = ge(u), i = 0, r = (a = ge(e)).length; i < r; i++) o = a[i], "input" === (c = (l = s[i]).nodeName.toLowerCase()) && pe.test(o.type) ? l.checked = o.checked : "input" !== c && "textarea" !== c || (l.defaultValue = o.defaultValue);
            if (t)
                if (n)
                    for (a = a || ge(e), s = s || ge(u), i = 0, r = a.length; i < r; i++) Oe(a[i], s[i]);
                else Oe(e, u);
        ...
        _.fn[e] = function(e) {
            for (var n, i = [], r = _(e), a = r.length - 1, s = 0; s <= a; s++) n = s === a ? this : this.clone(!0), _(r[s])[t](n), o.apply(i, n.get());
    ...
    function ze(e, t, n) {
        ...
        return (n = n || qe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || ae(e) || (s = _.style(e, t)), !f.pixelBoxStyles() && Fe.test(s) && Be.test(t) && (i = o.width, r = o.minWidth, a = o.maxWidth, o.minWidth = o.maxWidth = o.width = s, s = n.width, o.width = i, o.minWidth = r, o.maxWidth = a)), void 0 !== s ? s + "" : s
    }
    ...
    function We(e, t) {
        ...
        function t() {
            if (u) {
                ...
                r = "1%" !== t.top, l = 12 === n(t.marginLeft), u.style.right = "60%", o = 36 === n(t.right), a = 36 === n(t.width), u.style.position = "absolute", s = 12 === n(u.offsetWidth / 3), re.removeChild(c), u = null
            }
        }
        ...
        var r, a, s, o, l, c = i.createElement("div"),
    ...
    function Ke(e) {
        return _.cssProps[e] || Ye[e] || (e in Ue ? e : Ye[e] = function(e) {
    ...
    function et(e, t, n, i, r, a) {
        ...
        for (; s < 4; s += 2) "margin" === n && (l += _.css(e, n + ie[s], !0, r)), i ? ("content" === n && (l -= _.css(e, "padding" + ie[s], !0, r)), "margin" !== n && (l -= _.css(e, "border" + ie[s] + "Width", !0, r))) : (l += _.css(e, "padding" + ie[s], !0, r), "padding" !== n ? l += _.css(e, "border" + ie[s] + "Width", !0, r) : o += _.css(e, "border" + ie[s] + "Width", !0, r));
    ...
    function tt(e, t, n) {
        ...
        return (!f.boxSizingReliable() && r || "auto" === s || !parseFloat(s) && "inline" === _.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === _.css(e, "boxSizing", !1, i), (a = o in e) && (s = e[o])), (s = parseFloat(s) || 0) + et(e, t, n || (r ? "border" : "content"), a, i, s) + "px"
    }
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, a, s, o = Y(t),
                    l = Xe.test(t),
                    c = e.style;
                if (l || (t = Ke(o)), s = _.cssHooks[t] || _.cssHooks[o], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t];
                "string" == (a = typeof n) && (r = ne.exec(n)) && r[1] && (n = ce(e, t, r), a = "number"), null != n && n == n && ("number" !== a || l || (n += r && r[3] || (_.cssNumber[o] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var r, a, s, o = Y(t);
            return Xe.test(t) || (t = Ke(o)), (s = _.cssHooks[t] || _.cssHooks[o]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = ze(e, t, i)), "normal" === r && t in Qe && (r = Qe[t]), "" === n || n ? (a = parseFloat(r), !0 === n || isFinite(a) ? a || 0 : r) : r
        }
    }), _.each(["height", "width"], function(e, t) {
        _.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !Ge.test(_.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, t, i) : le(e, Ze, function() {
                    return tt(e, t, i)
                })
            },
            set: function(e, n, i) {
                var r, a = qe(e),
                    ...
                    o = (s || i) && "border-box" === _.css(e, "boxSizing", !1, a),
                    l = i ? et(e, t, i, o, a) : 0;
                return o && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(a[t]) - et(e, t, "border", !1, a) - .5)), l && (r = ne.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = _.css(e, t)), Je(0, n, l)
            }
        }
    }), _.cssHooks.marginLeft = We(f.reliableMarginLeft, function(e, t) {
        ...
        css: function(e, t) {
            return z(this, function(e, t, n) {
                var i, r, a = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (i = qe(e), r = t.length; s < r; s++) a[t[s]] = _.css(e, t[s], !1, i);
                    return a
                }
    ...
    var it, rt, at, st, ot = /^(?:toggle|show|hide)$/,
        lt = /queueHooks$/;
    ...
    function ht(e, t, n) {
        var i, r, a = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = it || ut(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), a = 0, s = c.tweens.length; a < s; a++) c.tweens[a].run(i);
        ...
        for (function(e, t) {
                var n, i, r, a, s;
                for (n in e)
                    if (r = t[i = Y(n)], a = e[n], Array.isArray(a) && (r = a[1], a = e[n] = a[0]), n !== i && (e[i] = a, delete e[n]), (s = _.cssHooks[i]) && "expand" in s)
                        for (n in a = s.expand(a), delete e[i], a) n in e || (e[n] = a[n], t[n] = r);
                    else t[i] = r
            }(u, c.opts.specialEasing); a < s; a++)
            if (i = ht.prefilters[a].call(c, e, u, c.opts)) return m(i.stop) && (_._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return _.map(u, pt, c), m(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), _.fx.timer(_.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    _.Animation = _.extend(ht, {
        ...
        prefilters: [function(e, t, n) {
            var i, r, a, s, o, l, c, u, d = "width" in t || "height" in t,
                p = this,
                h = {},
                f = e.style,
                m = e.nodeType && oe(e),
            ...
            if ((l = !_.isEmptyObject(t)) || !_.isEmptyObject(h))
                for (i in d && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = g && g.display) && (c = X.get(e, "display")), "none" === (u = _.css(e, "display")) && (c ? u = c : (de([e], !0), c = e.style.display || c, u = _.css(e, "display"), de([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === _.css(e, "float") && (l || (p.done(function() {
                        f.display = c
                    }), null == c && (u = f.display, c = "none" === u ? "" : u)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", p.always(function() {
                        f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
                    })), l = !1, h) l || (g ? "hidden" in g && (m = g.hidden) : g = X.access(e, "fxshow", {
                    display: c
                }), a && (g.hidden = !m), m && de([e], !0), p.done(function() {
                    for (i in m || de([e]), X.remove(e, "fxshow"), h) _.style(e, i, h[i])
    ...
    }, at = i.createElement("input"), st = i.createElement("select").appendChild(i.createElement("option")), at.type = "checkbox", f.checkOn = "" !== at.value, f.optSelected = st.selected, (at = i.createElement("input")).value = "t", at.type = "radio", f.radioValue = "t" === at.value;
    ...
    _.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : m(e) ? this.each(function(n) {
                ...
                var t, r, a, s;
                if (i)
                    for (r = 0, a = _(this), s = xt(e); t = s[r++];) a.hasClass(t) ? a.removeClass(t) : a.addClass(t);
    ...
    _.fn.extend({
        ...
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, i, r = e.options, a = _.makeArray(t), s = r.length; s--;)((i = r[s]).selected = -1 < _.inArray(_.valHooks.option.get(i), a)) && (n = !0);
    ...
    _.extend(_.event, {
        trigger: function(t, n, r, a) {
            ...
            if (o = f = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !wt.test(y + _.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[_.expando] ? t : new _.Event(y, "object" == typeof t && t)).isTrigger = a ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : _.makeArray(n, [t]), h = _.event.special[y] || {}, a || !h.trigger || !1 !== h.trigger.apply(r, n))) {
                ...
                for (s = 0;
                    (o = v[s++]) && !t.isPropagationStopped();) f = o, t.type = 1 < s ? c : h.bindType || y, (p = (X.get(o, "events") || {})[t.type] && X.get(o, "handle")) && p.apply(o, n), (p = u && o[u]) && p.apply && K(o) && (t.result = p.apply(o, n), !1 === t.result && t.preventDefault());
                return t.type = y, a || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(v.pop(), n) || !K(r) || u && m(r[y]) && !g(r) && ((l = r[u]) && (r[u] = null), _.event.triggered = y, t.isPropagationStopped() && f.addEventListener(y, kt), r[y](), t.isPropagationStopped() && f.removeEventListener(y, kt), _.event.triggered = void 0, l && (r[u] = l)), t.result
            }
        },
    ...
    function It(e, t, n, i) {
        ...
        if (Array.isArray(t)) _.each(t, function(t, r) {
            n || $t.test(e) ? i(e, r) : It(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
        });
    ...
    _.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !_(this).is(":disabled") && Et.test(this.nodeName) && !Mt.test(e) && (this.checked || !pe.test(e))
            }).map(function(e, t) {
                var n = _(this).val();
    ...
    function zt(e, t, n, i) {
        ...
        function s(o) {
            var l;
            return r[o] = !0, _.each(e[o] || [], function(e, o) {
                var c = o(t, n, i);
    ...
    qt.href = Ct.href, _.extend({
        ...
        ajax: function(t, n) {
            ...
            var r, a, s, o, l, c, u, d, p, h, f = _.ajaxSetup({}, n),
                m = f.context || f,
                ...
                C = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (u) {
                            if (!o)
                                for (o = {}; t = Pt.exec(s);) o[t[1].toLowerCase() + " "] = (o[t[1].toLowerCase() + " "] || []).concat(t[2]);
                            t = o[e.toLowerCase() + " "]
                        }
            ...
            if (v.promise(C), f.url = ((t || f.url || Ct.href) + "").replace(Ot, Ct.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(H) || [""], null == f.crossDomain) {
                c = i.createElement("a");
                try {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = _.param(f.data, f.traditional)), zt(Rt, f, n, C), u) return C;
            for (p in (d = _.event && f.global) && 0 == _.active++ && _.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Ht.test(f.type), a = f.url.replace(jt, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(At, "+")) : (h = f.url.slice(a.length), f.data && (f.processData || "string" == typeof f.data) && (a += (Tt.test(a) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (a = a.replace(Nt, "$1"), h = (Tt.test(a) ? "&" : "?") + "_=" + Dt++ + h), f.url = a + h), f.ifModified && (_.lastModified[a] && C.setRequestHeader("If-Modified-Since", _.lastModified[a]), _.etag[a] && C.setRequestHeader("If-None-Match", _.etag[a])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && C.setRequestHeader("Content-Type", f.contentType), C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : f.accepts["*"]), f.headers) C.setRequestHeader(p, f.headers[p]);
            if (f.beforeSend && (!1 === f.beforeSend.call(m, C, f) || u)) return C.abort();
            if (k = "abort", y.add(f.complete), C.done(f.success), C.fail(f.error), r = zt(Lt, f, n, C)) {
            ...
            function D(t, n, i, o) {
                var c, p, h, x, w, k = n;
                u || (u = !0, l && e.clearTimeout(l), r = void 0, s = o || "", C.readyState = 0 < t ? 4 : 0, c = 200 <= t && t < 300 || 304 === t, i && (x = function(e, t, n) {
    ...
    f.cors = !!Ut && "withCredentials" in Ut, f.ajax = Ut = !!Ut, _.ajaxTransport(function(t) {
        ...
        if (f.cors || Ut && !t.crossDomain) return {
            send: function(r, a) {
                ...
                n = function(e) {
                    return function() {
                        n && (n = i = o.onload = o.onerror = o.onabort = o.ontimeout = o.onreadystatechange = null, "abort" === e ? o.abort() : "error" === e ? "number" != typeof o.status ? a(0, "error") : a(o.status, o.statusText) : a(Vt[o.status] || o.status, o.statusText, "text" !== (o.responseType || "text") || "string" != typeof o.responseText ? {
                            binary: o.response
                        } : {
                            text: o.responseText
    ...
    _.ajaxSetup({
        ...
        if (o || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = m(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, o ? t[o] = t[o].replace(Gt, "$1" + r) : !1 !== t.jsonp && (t.url += (Tt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
            return s || _.error(r + " was not called"), s[0]
        }, t.dataTypes[0] = "json", a = e[r], e[r] = function() {
            s = arguments
        }, i.always(function() {
            void 0 === a ? _(e).removeProp(r) : e[r] = a, t[r] && (t.jsonpCallback = n.jsonpCallback, Kt.push(r)), s && m(a) && a(s[0]), s = a = void 0
        }), "script"
    }), f.createHTMLDocument = ((Yt = i.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Yt.childNodes.length), _.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (f.createHTMLDocument ? ((r = (t = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, t.head.appendChild(r)) : t = i), s = !n && [], (a = M.exec(e)) ? [t.createElement(a[1])] : (a = _e([e], t, s), s && s.length && _(s).remove(), _.merge([], a.childNodes)));
        var r, a, s
    }, _.fn.load = function(e, t, n) {
        var i, r, a, s = this,
            o = e.indexOf(" ");
        return -1 < o && (i = yt(e.slice(o)), e = e.slice(0, o)), m(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), 0 < s.length && _.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        }).done(function(e) {
            a = arguments, s.html(i ? _("<div>").append(_.parseHTML(e)).find(i) : e)
        ...
        setOffset: function(e, t, n) {
            var i, r, a, s, o, l, c = _.css(e, "position"),
                u = _(e),
                d = {};
            "static" === c && (e.style.position = "relative"), o = u.offset(), a = _.css(e, "top"), l = _.css(e, "left"), ("absolute" === c || "fixed" === c) && -1 < (a + l).indexOf("auto") ? (s = (i = u.position()).top, r = i.left) : (s = parseFloat(a) || 0, r = parseFloat(l) || 0), m(t) && (t = t.call(e, n, _.extend({}, o))), null != t.top && (d.top = t.top - o.top + s), null != t.left && (d.left = t.left - o.left + r), "using" in t ? t.using.call(e, d) : u.css(d)
        }
    }, _.fn.extend({
        offset: function(e) {
        ...
        _.cssHooks[t] = We(f.pixelPosition, function(e, n) {
            if (n) return n = ze(e, t), Fe.test(n) ? _(e).position()[t] + "px" : n
        })
    }), _.each({
        Height: "height",
        Width: "width"
        ...
        _.each({
            ...
            _.fn[i] = function(r, a) {
                ...
                return z(this, function(t, n, r) {
                    var a;
                    return g(t) ? 0 === i.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (a = t.documentElement, Math.max(t.body["scroll" + e], a["scroll" + e], t.body["offset" + e], a["offset" + e], a["client" + e])) : void 0 === r ? _.css(t, n, o) : _.style(t, n, r, o)
                }, t, s ? r : void 0, s)
            }
        })
    ...
    }, _.isArray = Array.isArray, _.parseJSON = JSON.parse, _.nodeName = S, _.isFunction = m, _.isWindow = g, _.camelCase = Y, _.type = b, _.now = Date.now, _.isNumeric = function(e) {
        var t = _.type(e);
    ...
    return _.noConflict = function(t) {
        return e.$ === _ && (e.$ = Zt), t && e.jQuery === _ && (e.jQuery = Xt), _
    }, t || (e.jQuery = e.$ = _), _
}),
function(e) {
    "function" == typeof define && define.amd ? define(["jquery"], e) : e("object" == typeof exports ? require("jquery") : window.jQuery || window.Zepto)
}(function(e) {
    var t, n, i, r, a, s, o = "Close",
        l = "BeforeClose",
        c = "MarkupParse",
        u = "Open",
        d = "Change",
    ...
    v.prototype = {
        ...
        open: function(n) {
            ...
            if (!t.isOpen) {
                ...
                w("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (x(c, function(e, t, n, i) {
                ...
                }, 16), t.isOpen = !0, t.updateSize(p), w(u), n
            }
            t.updateItemHTML()
        },
        close: function() {
        ...
        updateItemHTML: function() {
            ...
            if (w("BeforeChange", [t.currItem ? t.currItem.type : "", i]), t.currItem = n, !t.currTemplate[i]) {
                ...
                w("FirstMarkupParse", a), t.currTemplate[i] = !a || e(a)
            }
            r && r !== n.type && t.container.removeClass("mfp-" + r + "-holder");
            var s = t["get" + i.charAt(0).toUpperCase() + i.slice(1)](n, t.currTemplate[i]);
            t.appendContent(s, i), n.preloaded = !0, w(d, n), r = n.type, t.container.prepend(t.contentContainer), w("AfterChange")
        },
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                ...
                a.items ? r = a.items[s] : (r = i, a.delegate && (r = r.find(a.delegate)), r = r.eq(s)), t._openClick({
                    mfpEl: r
                }, i, a)
    ...
    var D, T, $, S = "inline",
        M = function() {
            $ && (T.after($.addClass(D)).detach(), $ = null)
        };
            ...
            getInline: function(n, i) {
                if (M(), n.src) {
                    ...
                    if (a.length) {
                        ...
                        s && s.tagName && (T || (D = r.hiddenClass, T = _(D), D = "mfp-" + D), $ = a.after(T).detach().removeClass(D)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(I, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(I), E = t.st.ajax.cursor, x(o + "." + I, j), x("BeforeChange." + I, j)
            },
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, r, a) {
                        ...
                        w("ParseAjax", s), t.appendContent(e(s.data), I), n.finished = !0, A(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(f)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, N && clearInterval(N), e.isCheckingImgSize = !1, w("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
            ...
            getImage: function(n, i) {
                var r = 0,
                    a = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, w("ImageLoadComplete")) : 200 > ++r ? setTimeout(a, 100) : s())
                    },
                    s = function() {
                ...
                if (l.length) {
                    ...
                    c.className = "mfp-img", n.el && n.el.find("img").length && (c.alt = n.el.find("img").attr("alt")), n.img = e(c).on("load.mfploader", a).on("error.mfploader", s), c.src = n.src, l.is("img") && (n.img = n.img.clone()), (c = n.img[0]).naturalWidth > 0 ? n.hasSize = !0 : c.width || (n.hasSize = !1)
                }
                return t._parseMarkup(i, {
                    title: P(n),
                    img_replaceWith: n.img
                }, n), t.resizeImage(), n.hasSize ? (N && clearInterval(N), n.loadError ? (i.addClass("mfp-loading"), t.updateStatus("error", o.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), t.updateStatus("ready")), i) : (t.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, i.addClass("mfp-loading"), t.findImageSize(n)), i)
            }
        }
    });
    var H;
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(n) {
                ...
                return void 0 === H && (H = void 0 !== document.createElement("p").style.MozTransform), H ? o["-moz-transform"] = o.transform = "translate(" + r.left + "px," + r.top + "px)" : (o.left = r.left, o.top = r.top), o
            }
        }
    });
    var O = "iframe",
    ...
    e.magnificPopup.registerModule(O, {
        ...
        proto: {
            initIframe: function() {
                t.types.push(O), x("BeforeChange", function(e, t, n) {
                    t !== n && (t === O ? R() : n === O && R(!0))
                }), x(o + "." + O, function() {
                    R()
                })
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var n = t.st.gallery,
                    r = ".mfp-gallery";
                return t.direction = !0, !(!n || !n.enabled) && (a += " mfp-gallery", x(u + r, function() {
                ...
                }), x(c + r, function(e, i, r, a) {
                    var s = t.items.length;
                    r.counter = s > 1 ? F(n.tCounter, a.index, s) : ""
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina,
                        n = e.ratio;
                    (n = isNaN(n) ? n() : n) > 1 && (x("ImageHasSize." + q, function(e, t) {
                        t.img.css({
...
function(e, t, n) {
    ...
    var t = function(t, n, i) {
        var r = {
            ...
            getCaret: function() {
                try {
                    var e, n = 0,
                        ...
                        s = i.selectionStart;
                    return a && -1 === navigator.appVersion.indexOf("MSIE 10") ? ((e = a.createRange()).moveStart("character", -r.val().length), n = e.text.length) : (s || "0" === s) && (n = s), n
                } catch (e) {}
            },
            setCaret: function(e) {
                try {
            ...
            getRegexMask: function() {
                for (var e, t, i, r, a, o, l = [], c = 0; c < n.length; c++)(e = s.translation[n.charAt(c)]) ? (t = e.pattern.toString().replace(/.{1}$|^.{1}/g, ""), i = e.optional, (r = e.recursive) ? (l.push(n.charAt(c)), a = {
                    digit: n.charAt(c),
                    pattern: t
                }) : l.push(i || r ? t + "?" : t)) : l.push(n.charAt(c).replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
                return o = l.join(""), a && (o = o.replace(new RegExp("(" + a.digit + "(.*" + a.digit + ")?)"), "($1)?").replace(new RegExp(a.digit, "g"), a.pattern)), new RegExp(o)
            },
            ...
            calculateCaretPosition: function(e) {
                var n = r.getMasked(),
                    i = r.getCaret();
                if (e !== n) {
                    var a = t.data("mask-previus-caret-pos") || 0,
                        s = n.length,
                        o = e.length,
                        l = 0,
                        c = 0,
                        ...
                        d = 0,
                        p = 0;
                    for (p = i; p < s && r.maskDigitPosMap[p]; p++) c++;
                    for (p = i - 1; p >= 0 && r.maskDigitPosMap[p]; p--) l++;
                    for (p = i - 1; p >= 0; p--) r.maskDigitPosMap[p] && u++;
                    for (p = a - 1; p >= 0; p--) r.maskDigitPosMapOld[p] && d++;
                    if (i > o) i = 10 * s;
                    else if (a >= i && a !== o) {
                        if (!r.maskDigitPosMapOld[i]) {
                            var h = i;
                            i -= d - u, i -= l, r.maskDigitPosMap[i] && (i = h)
                        }
                    } else i > a && (i += u - d, i += c)
                }
                return i
            ...
            behaviour: function(n) {
                ...
                if (-1 === e.inArray(i, s.byPassKeys)) {
                    ...
                    }, e.jMaskGlobals.keyStrokeCompensation), r.val(a), r.setCaret(o), r.callbacks(n)
                }
            },
            getMasked: function(e, t) {
                var a, o, l, c = [],
                    ...
                    y = 0,
                    b = [];
                for (i.reverse ? (g = "unshift", m = -1, a = 0, d = p - 1, h = f - 1, o = function() {
                        return d > -1 && h > -1
                    }) : (a = p - 1, o = function() {
                        return d < p && h < f
                    }); o();) {
                    var x = n.charAt(d),
                        _ = u.charAt(h),
                        w = s.translation[x];
                    w ? (_.match(w.pattern) ? (c[g](_), w.recursive && (-1 === v ? v = d : d === a && d !== v && (d = v - m), a === v && (d -= m)), d += m) : _ === l ? (y--, l = void 0) : w.optional ? (d += m, h -= m) : w.fallback ? (c[g](w.fallback), d += m, h -= m) : r.invalid.push({
                        p: h,
                        v: _,
                        e: w.pattern
                    }), h += m) : (e || c[g](x), _ === x ? (b.push(h), h += m) : (l = x, b.push(h + y), y++), d += m)
                }
                var k = n.charAt(a);
                p !== f + 1 || s.translation[k] || c.push(k);
                var C = c.join("");
                return r.mapMaskdigitPositions(C, b, f), C
            },
            mapMaskdigitPositions: function(e, t, n) {
                var a = i.reverse ? e.length - n : 0;
                r.maskDigitPosMap = {};
                for (var s = 0; s < t.length; s++) r.maskDigitPosMap[t[s] + a] = 1
            },
            callbacks: function(e) {
                ...
                c("onChange", !0 === s, l), c("onKeyPress", !0 === s, l), c("onComplete", a.length === n.length, l), c("onInvalid", r.invalid.length > 0, [a, e, t, r.invalid, i])
            }
        };
        t = e(t);
        var a, s = this,
        ...
        n = "function" == typeof n ? n(r.val(), void 0, t, i) : n, s.mask = n, s.options = i, s.remove = function() {
            ...
            if (o = o || !1, i = i || {}, s.clearIfNotMatch = e.jMaskGlobals.clearIfNotMatch, s.byPassKeys = e.jMaskGlobals.byPassKeys, s.translation = e.extend({}, e.jMaskGlobals.translation, i.translation), s = e.extend(!0, {}, s, i), a = r.getRegexMask(), o) r.events(), r.val(r.getMasked());
            else {
                i.placeholder && t.attr("placeholder", i.placeholder), t.data("mask") && t.attr("autocomplete", "off");
                for (var l = 0, c = !0; l < n.length; l++) {
                    var u = s.translation[n.charAt(l)];
                    if (u && u.recursive) {
                        c = !1;
                        break
                    }
    ...
    var n = function() {
            var n = e(this),
                r = {},
                a = n.attr("data-mask");
            if (n.attr("data-mask-reverse") && (r.reverse = !0), n.attr("data-mask-clearifnotmatch") && (r.clearIfNotMatch = !0), "true" === n.attr("data-mask-selectonfocus") && (r.selectOnFocus = !0), i(n, a, r)) return n.data("mask", new t(this, a, r))
        },
        i = function(t, n, i) {
            i = i || {};
            var r = e(t).data("mask"),
                ...
                s = e(t).val() || e(t).text();
            try {
                return "function" == typeof n && (n = n(s)), "object" != typeof r || a(r.options) !== a(i) || r.mask !== n
            } catch (e) {}
        };
    e.fn.mask = function(n, r) {
        ...
        return e(this).each(c), a && "" !== a && l && (clearInterval(e.maskWatchers[a]), e.maskWatchers[a] = setInterval(function() {
            e(document).find(a).each(c)
        }, o)), this
    ...
    var r, a, s, o = {
        ...
        useInput: !/Chrome\/[2-4][0-9]|SamsungBrowser/.test(window.navigator.userAgent) && (r = "input", s = document.createElement("div"), (a = (r = "on" + r) in s) || (s.setAttribute(r, "return;"), a = "function" == typeof s[r]), s = null, a),
        watchDataMask: !1,
...
function(e, t, n) {
    ...
    s = "datepicker", o = !1, l = {
            ...
            _buildDatepickersContainer: function() {
                o = !0, i.append('<div class="datepickers-container" id="datepickers-container"></div>'), r = t("#datepickers-container")
            },
            ...
            formatDate: function(e, t) {
                ...
                var n, i = e,
                    ...
                    u = c.fullHours,
                    d = c.hours,
                    p = e.match(r("aa")) || e.match(r("AA")),
                    h = "am",
                    f = this._replacer;
                switch (this.opts.timepicker && this.timepicker && p && (u = o((n = this.timepicker._getValidHoursFromDate(t, p)).hours), d = n.hours, h = n.dayPeriod), !0) {
                    case /@/.test(i):
                    ...
                    case /d/.test(i):
                        i = f(i, r("d"), c.date);
                    case /DD/.test(i):
                        i = f(i, r("DD"), s.days[c.day]);
                    case /D/.test(i):
                        i = f(i, r("D"), s.daysShort[c.day]);
                    case /mm/.test(i):
                    ...
                    case /M/.test(i):
                        i = f(i, r("M"), s.monthsShort[c.month]);
                    case /ii/.test(i):
            ...
            selectDate: function(e) {
                ...
                if (Array.isArray(e)) e.forEach(function(e) {
                    ...
                    if (this.lastSelectedDate = e, this.timepicker && this.timepicker._setTime(e), t._trigger("selectDate", e), this.timepicker && (e.setHours(this.timepicker.hours), e.setMinutes(this.timepicker.minutes)), "days" == t.view && e.getMonth() != i.month && n.moveToOtherMonthsOnSelect && (s = new Date(e.getFullYear(), e.getMonth(), 1)), "years" == t.view && e.getFullYear() != i.year && n.moveToOtherYearsOnSelect && (s = new Date(e.getFullYear(), 0, 1)), s && (t.silent = !0, t.date = s, t.silent = !1, t.nav._render()), n.multipleDates && !n.range) {
                        if (r === n.multipleDates) return;
                        t._isSelected(e) || t.selectedDates.push(e)
                    } else n.range ? 2 == r ? (t.selectedDates = [e], t.minRange = e, t.maxRange = "") : 1 == r ? (t.selectedDates.push(e), t.maxRange ? t.minRange = e : t.maxRange = e, a.bigger(t.maxRange, t.minRange) && (t.maxRange = t.minRange, t.minRange = e), t.selectedDates = [t.minRange, t.maxRange]) : (t.selectedDates = [e], t.minRange = e) : t.selectedDates = [e];
            ...
            removeDate: function(e) {
                ...
                if (e instanceof Date) return t.some(function(i, r) {
                    return a.isSame(i, e) ? (t.splice(r, 1), n.selectedDates.length ? n.lastSelectedDate = n.selectedDates[n.selectedDates.length - 1] : (n.minRange = "", n.maxRange = "", n.lastSelectedDate = ""), n.views[n.currentView]._render(), n._setInputValue(), n.opts.onSelect && n._triggerOnChange(), !0) : void 0
                })
            },
            today: function() {
            ...
            _isSelected: function(e, t) {
                ...
                return this.selectedDates.some(function(i) {
                    return a.isSame(i, e, t) ? (n = i, !0) : void 0
                }), n
            },
            ...
            _isInRange: function(e, t) {
                var n = e.getTime(),
                    i = a.getParsedDate(e),
                    r = a.getParsedDate(this.minDate),
                    s = a.getParsedDate(this.maxDate),
                    o = new Date(i.year, i.month, r.date).getTime(),
            ...
            _handleHotKey: function(e) {
                var t, n, i, r = a.getParsedDate(this._getFocusedDate()),
                    s = this.opts,
                    o = !1,
                    l = !1,
                    c = !1,
                ...
                i = a.getDaysCount(new Date(u, d)), n = new Date(u, d, p), p > i && (p = i), n.getTime() < this.minTime ? n = this.minDate : n.getTime() > this.maxTime && (n = this.maxDate), this.focused = n, t = a.getParsedDate(n), o && s.onChangeMonth && s.onChangeMonth(t.month, t.year), l && s.onChangeYear && s.onChangeYear(t.year), c && s.onChangeDecade && s.onChangeDecade(this.curDecade)
            },
            ...
            _focusNextCell: function(e, t) {
                t = t || this.cellType;
                var n = a.getParsedDate(this._getFocusedDate()),
                    i = n.year,
                    r = n.month,
                    s = n.date;
            ...
            _getCell: function(e, n) {
                ...
                return (i = this.views[this.currentView].$el.find(s)).length ? i : t("")
            },
            destroy: function() {
                var e = this;
            ...
            _onMouseEnterCell: function(e) {
                ...
                this.silent = !0, this.focused && (this.focused = ""), n.addClass("-focus-"), this.focused = i, this.silent = !1, this.opts.range && 1 == this.selectedDates.length && (this.minRange = this.selectedDates[0], this.maxRange = "", a.less(this.minRange, this.focused) && (this.maxRange = this.minRange, this.minRange = ""), this.views[this.currentView]._update())
            },
        ...
        }, a.isSame = function(e, t, n) {
            if (!e || !t) return !1;
            var i = a.getParsedDate(e),
                r = a.getParsedDate(t),
                s = n || "day";
            return {
        ...
        }, a.less = function(e, t, n) {
            return !(!e || !t) && t.getTime() < e.getTime()
        }, a.bigger = function(e, t, n) {
            return !(!e || !t) && t.getTime() > e.getTime()
            ...
            t(".datepicker-here100").datepicker()
        }),
        function() {
            var e = {
            ...
            i.Body = function(e, n, i) {
                ...
                _getDayNamesHtml: function(e, t, i, r) {
                    return t = t != n ? t : e, i = i || "", (r = r != n ? r : 0) > 7 ? i : 7 == t ? this._getDayNamesHtml(e, 0, i, ++r) : (i += '<div class="datepicker--day-name' + (this.d.isWeekend(t) ? " -weekend-" : "") + '">' + this.d.loc.daysMin[t] + "</div>", this._getDayNamesHtml(e, ++t, i, ++r))
                },
                _getCellContents: function(e, t) {
                    var n = "datepicker--cell datepicker--cell-" + t,
                        i = new Date,
                        a = this.d,
                        s = r.resetTime(a.minRange),
                        o = r.resetTime(a.maxRange),
                        l = a.opts,
                        c = r.getParsedDate(e),
                        u = {},
                        d = c.date;
                    switch (t) {
                        case "day":
                            a.isWeekend(c.day) && (n += " -weekend-"), c.month != this.d.parsedDate.month && (n += " -other-month-", l.selectOtherMonths || (n += " -disabled-"), l.showOtherMonths || (d = ""));
                            break;
                        case "month":
                            d = a.loc[a.opts.monthsField][c.month];
                            break;
                        case "year":
                            var p = a.curDecade;
                            d = c.year, (c.year < p[0] || c.year > p[1]) && (n += " -other-decade-", l.selectOtherYears || (n += " -disabled-"), l.showOtherYears || (d = ""))
                    }
                    return l.onRenderCell && (d = (u = l.onRenderCell(e, t) || {}).html ? u.html : d, n += u.classes ? " " + u.classes : ""), l.range && (r.isSame(s, e, t) && (n += " -range-from-"), r.isSame(o, e, t) && (n += " -range-to-"), 1 == a.selectedDates.length && a.focused ? ((r.bigger(s, e) && r.less(a.focused, e) || r.less(o, e) && r.bigger(a.focused, e)) && (n += " -in-range-"), r.less(o, e) && r.isSame(a.focused, e) && (n += " -range-from-"), r.bigger(s, e) && r.isSame(a.focused, e) && (n += " -range-to-")) : 2 == a.selectedDates.length && r.bigger(s, e) && r.less(o, e) && (n += " -in-range-")), r.isSame(i, e, t) && (n += " -current-"), a.focused && r.isSame(e, a.focused, t) && (n += " -focus-"), a._isSelected(e, t) && (n += " -selected-"), (!a._isInRange(e, t) || u.disabled) && (n += " -disabled-"), {
                        html: d,
                        classes: n
                    }
                },
                _getDaysHtml: function(e) {
                    for (var t, n, i = r.getDaysCount(e), a = new Date(e.getFullYear(), e.getMonth(), 1).getDay(), s = new Date(e.getFullYear(), e.getMonth(), i).getDay(), o = a - this.d.loc.firstDay, l = 6 - s + this.d.loc.firstDay, c = "", u = 1 - (o = 0 > o ? o + 7 : o), d = i + (l = l > 6 ? l - 7 : l); d >= u; u++) n = e.getFullYear(), t = e.getMonth(), c += this._getDayHtml(new Date(n, t, u));
                    return c
                },
                ...
                _getYearsHtml: function(e) {
                    for (var t = (r.getParsedDate(e), r.getDecade(e)), n = "", i = t[0] - 1; i <= t[1] + 1; i++) n += this._getYearHtml(new Date(i, 0));
                    return n
                },
                ...
                _update: function() {
                    var e, n, i, r = t(".datepicker--cell", this.$cells),
                        a = this;
                    r.each(function(r, s) {
                        n = t(this), i = a.d._getDateFromCell(t(this)), e = a._getCellContents(i, a.d.cellType), n.attr("class", e.classes)
                    })
                },
                show: function() {
                ...
                _handleClick: function(e) {
                    ...
                    if (r.view == this.opts.minView) {
                        var a = new Date(i, n, t),
                            s = this.d._isSelected(a, this.d.cellType);
                        return s ? void r._handleAlreadySelectedDates.bind(r, s, a)() : void r._trigger("clickCell", a)
                    }
                    r.down(new Date(i, n, t))
                },
    ...
    var e = {
        is_harder_str: function(e) {
            if (-1 === e.val().search("-")) return !1
        },
        correction_plain_str: function(e) {
            return e.val()[0].toUpperCase() + e.val().slice(1).toLowerCase()
        },
        correction_harder_str: function(e) {
            var t = e.val().split("-");
            return t[0][0].toUpperCase() + t[0].slice(1).toLowerCase() + "-" + t[1][0].toUpperCase() + t[1].slice(1).toLowerCase()
        }
    };
    ...
    var t = window.location.pathname; - 1 != t.search("contact_us/") && form_us_two(), -1 == t.search("/forma-obrashenija/") && 0 != $(".header__r_auth_reg").length && $(".header__r_auth_reg").attr("data-rigstration", "2"), $(document).mouseup(function(e) {
        var t = $(".danger");
        t.is(e.target) || t.remove();
        var n = $(".popover_error");
        n.is(e.target) || n.fadeToggle(400, "linear", function() {
            n.remove()
        }), $(".error_step-card-1").removeClass("error_block"), $(".error_step-card-3").removeClass("error_block"), $(".error_step-card-4").removeClass("error_block")
    }), $(".header__r_auth_reg").click(function() {
        setTimeout(function() {
            ! function() {
                $("#famaly-name, #name , #last-name").bind("change keyup input click", function() {
                    this.value.match(/[^а-яёА-ЯЁ\-]/g) && (this.value = this.value.replace(/[^а-яёА-ЯЁ\-]/g, ""))
                }), $("#phone").mask("+7(000)000-00-00"), $("#famaly-name").on("keyup", function() {
                    var t = $(this);
                    clearTimeout(t.data("timer")), t.data("timer", setTimeout(function() {
                        if (t.removeData("timer"), t.val().length > 0)
                            if (!1 === e.is_harder_str(t)) {
                                var n = e.correction_plain_str(t);
                                t.val(n)
                            } else {
                                var n = e.correction_harder_str(t);
                                t.val(n)
                            }
                    }, 2200))
                ...
                let t = new Date,
                    n = t.getFullYear() - 18;
                t.setFullYear(n), $("#datepicker_reg").datepicker({
                    maxDate: t,
                    ...
                    $("#referal").val($(this).text()), $("#search_result").fadeOut()
                    ...
                    let t = $("#referal");
                    0 === t.has(e.target).length && $("#search_result").fadeOut()
                }), $(document).on("click", "#search_result_hospital li", function() {
                    $("#referal_two").val($(this).text()), $("#search_result_hospital").fadeOut()
                }), $(document).on("click", "#referal_two", function() {
                    $("#search_result_hospital").css({
                        display: "block"
                    })
                }), $(document).mouseup(function(e) {
                    let t = $("#referal_two");
                    0 === t.has(e.target).length && $("#search_result_hospital").fadeOut()
                }), $("#referal").on("keyup", function() {
                    var e = $(this);
                    "" == e.val() && (e.attr("data-id_region", ""), $(".hospital_reg").each(function() {
                        $(this).remove()
                    }), $("#search_result").css({
                        display: "block"
                    }), $("#hospital").remove(), $("#referal_two").val(""), $("#referal_two").attr("data-id_region", "")), clearTimeout(e.data("timer")), e.data("timer", setTimeout(function() {
                        e.removeData("timer"), $.post("/ajax/search_for_reg/search_region.php", {
                            name_city: e.val()
                        }, function(e) {
                            0 != $(".error_region").length && $(".error_region").remove(), $(".region_reg").each(function() {
                                $(this).remove()
                            }), "error_region" == e ? 0 != $(".error_region").length ? ($(".error_region").remove(), $("#search_result").append('<li class="error_region" >Регион не найден</li>')) : $("#search_result").append('<li class="error_region" >Регион не найден</li>') : setTimeout(function() {
                    ...
                    $("#referal").attr("data-id_region", e), $("#referal").attr("data-region_check", "check"), $.post("/ajax/search_for_reg/search_company.php", {
                        region_id: $("#referal").attr("data-id_region")
                    }, function(e) {
                        0 != $(".error_region").length && $(".error_region").remove(), $(".hospital_reg").each(function() {
                            $(this).remove()
                        }), $(".referal_two_reg").val(""), $(".referal_two_reg").attr("data-id_region", ""), $(".referal_two_reg").removeAttr("data-region_check"), $(".hospital-empty").remove(), setTimeout(function() {
 $("#search_result_hospital").empty();                           
$("#search_result_hospital").append(e)
                        }, 100)
                    })
                }), $(document).on("click", ".hospital_reg", function() {
                    let e = $(this).attr("value"),
                        t = $(this).text();
                    $("#referal_two").val(t), $("#referal_two").attr("data-id_region", e), $("#referal_two").attr("data-region_check", "check")
                }), $("#referal_two").on("keyup", function() {
                    var e = $(this);
                    "" == e.val() && e.attr("data-id_region", ""), $("#search_result_hospital").css({
                        display: "block"
                    }), clearTimeout(e.data("timer")), e.data("timer", setTimeout(function() {
                        e.removeData("timer"), $.post("/ajax/search_for_reg/search_company.php", {
                            name_hospital: e.val(),
                            region_id: $("#referal").attr("data-id_region")
                        }, function(e) {
                            0 != $(".error_region").length && $(".error_region").remove(), $(".hospital_reg").each(function() {
                                $(this).remove()
                            }), $(".hospital-empty").remove(), "error_company" == e ? 0 != $(".error_region").length ? ($(".error_region").remove(), $("#search_result_hospital").append('<li class="error_region" >Компания не найдена</li>'), $(".hospital-empty").remove()) : ($("#search_result_hospital").append('<li class="error_region" >Компания не найдена</li>'), $(".hospital-empty").remove()) : setTimeout(function() {
                                $("#search_result_hospital").append(e)
                            }, 100)
                        })
                    }, 500))
                }), $(".accept-phone-js").click(function() {
                    $("#tel_confirm_error").css("display", "none"), !0 === $("#phone")[0].validity.valid ? (setCookie("phone", $("#phone").val()), $("#sms_confirm_error").css("display", "none"), $.ajax({
                        ...
                        success: function(e) {
                            "error" === e ? $("#tel_confirm_error").css("display", "block") : ($(".hidden_wrap_phone").css("display", "none"), $("#sms_confirm").css("display", "block"))
                        }
                    })) : $("#sms_confirm_error").css("display", "block")
                }), $(".sms-again-button").click(function() {
                    $("#tel_confirm_error").css("display", "none"), !0 === $("#phone")[0].validity.valid ? ($("#sms_confirm_error").css("display", "none"), $.ajax({
                        url: "/ajax/sms_code_generate.php",
                        type: "POST",
                        data: {
                            phone: $("#phone").val()
                        ...
                        success: function(e) {
                            "error" === e ? $("#tel_confirm_error").css("display", "block") : ($(".hidden_wrap_phone").css("display", "none"), $("#sms_confirm").css("display", "block"), $(".sms-again-button").prop("disabled", !0), timer_for_sms())
                        }
                    })) : $("#sms_confirm_error").css("display", "block")
                }), document.getElementById("password").onchange = validatePassword, document.getElementById("pass_conf").onchange = validatePassword, $("#auth-form-reg").validator().on("submit", function(e) {
                    e.preventDefault(), 0 != $("#strax-sluchay").length && $("#auth-form-reg").append("<input type='hidden'  name='review' value='review'>");
                    var t = [],
                        n = $("#auth-form-reg").serializeArray();
                    let i = $("#referal").attr("data-id_region");
                    "" == i || null == i || "0" == i ? ($("#referal").after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n        Выберите регион.\n      </div>\n      </div>'), t.push("error")) : n.push({
                        name: "id_region",
                        value: i
                    });
                    let r = $("#referal_two").attr("data-id_region");
                    "" == r || null == r || "0" == r ? ($("#referal_two").after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n        Выберите компанию.\n      </div>\n      </div>'), t.push("error")) : n.push({
                        name: "company",
                        value: r
                    });
                    let a = [],
                        s = $(".checkbox_registration_modal");
                    $(s).find("input:checked").each(function() {
                        a.push(this.value)
                    }), 0 == a.length && (s.children(".check-label").children(".check-img_reg").after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n          Подтвердите свое согласие.\n      </div>\n      </div>'), t.push("error8"));
                    var z = $(".datepicker-here").val().replace(/(\d*)-(\d*)-(\d*)/, '$3.$2.$1');
var o = z;
//$(this).next().val(this.value.replace(/(\d*)-(\d*)-(\d*)/, '$3-$2-$1'));
//alert (o);
                    if (/^(\d+)[.](\d+)[.](\d+)/.test(o) || ($(".datepicker-here").after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n          Выберите дату рождения.\n      </div>\n      </div>'), t.push("error9")), 0 === $("#check-code-js").val().length) $("#check-code-js").after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n         Введите код подтверждения.\n      </div>\n      </div>'), $(".accept-phone-js").after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n         Введите код подтверждения.\n      </div>\n      </div>'), t.push("error10");
                    else if ($("#check-code-js").val().length > 0) {
                        var l = getCookie("phone");
                        l != n[8].value && ($("#phone").after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n        Введный вами номер для подтверждения не соответсвтует текущему .\n      </div>\n      </div>'), t.push("error")), console.log("1"), 0 === t.length && $.ajax({
                            url: "/ajax/registration.php",
                            type: "POST",
                            data: n,
                            success: function(e) {
                                var t = JSON.parse(e);
                                if (void 0 !== t.error_phone) {
                                    var n = $("#phone");
                                    n.after('<div class="danger" data-danger-email>' + t.error + "</div>")
                                }
                                if ("mail" === t.error) {
                                    var n = $("#email");
                                    n.after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n         Пользователь с таким эмейлом уже сущесвуте.\n      </div>\n      </div>')
                                }
                                if ("polic" === t.error) {
                                    var n = $("#number_polic");
                                    n.after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n         Пользователь с таким полисом уже сущесвуте.\n      </div>\n      </div>')
                                }
                                if ("Нет компании" === t.company) {
                                    var i = $("#company");
                                    i.after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n        В нашей базе нет этой компании ,мы не можем вас зарегестрировать.\n      </div>\n      </div>')
                                }
                                void 0 !== t.error_sms && $("#check-code-js").after('   <div class="popover_error">\n          <div class="popover_error_arrow"></div>\n          <div class="popover_error_image">\n          <img src="/local/templates/kdteam/images/svg/error.svg" alt="Ошибка">\n          </div>\n          <div class="popover_error_text">\n        Неверный код подтверждения.\n      </div>\n      </div>'), "success" === t.user_success && ("0" == $(".header__r_auth_reg").attr("data-rigstration") ? ($("#auth-form-reg").find($(".close-modal")).trigger("click"), $(".header__r_auth_reg").attr("data-rigstration", "1"), $("body").css({
                                    overflow: "hidden"
                                }), $.ajax({
                                    dataType: "html",
                                    ...
                                    beforeSend: function() {},
                                    success: function(e) {
                                        $(".header__r").html(""), $(".header__r").html(e)
                                    }
                                }).done(function(e) {
                                    deleteCookie("phone"), setTimeout(function() {
                                        $.magnificPopup.open({
                                            items: {
                    ...
                    var e = $(this).text();
                    $("#company").val(e), $(".primer_company").remove()
                }), $(".numberInput").bind("change keyup input click", function() {
                    this.value.match(/[^0-9]/g) && (this.value = this.value.replace(/[^0-9]/g, ""))
                })
            }()
        ...
        setTimeout(function() {
            $("#auth-form-login").validator().on("submit", function(e) {
                return e.preventDefault(), $.ajax({
                    ...
                    dataType: "json",
                    success: function(e) {
                        e.status ? ($("#auth-form-login").find($(".close-modal")).trigger("click"), $(".header__r_auth_reg").attr("data-rigstration", "1"), $("body").css({
                            overflow: "hidden"
                        }), $.ajax({
                            dataType: "html",
                            url: "/ajax/forma-obrashenija/reload_header.php",
                            ...
                            beforeSend: function() {},
                            success: function(e) {
                                -1 !== window.location.href.search("/add-feedback/") && $(".name_user_no_Authorized").remove(), $(".header__r").html(""), $(".header__r").html(e)
                            }
                        }).done(function(e) {})) : ($(".message.error").html(e.message), $(".message.error").show())
                    }
                }), !1
            }), $("#trigger-reg-form").click(function() {
                $("#auth-form-login").find($(".close-modal")).trigger("click"), setTimeout(function() {
    ...
    $("#stars li").on("mouseover", function() {
        ...
        responseMessage("Спасибо! Ваша оценка " + n + ".")
    })
}), $(document).ready(function() {
    $(document).on("click", "#show-mnu", function() {
        $("#show-mnu").toggleClass("active")
    }), $(document).on("click", function(e) {
        $(e.target).closest("#show-mnu , #menu ").length || $("#show-mnu").removeClass("active"), e.stopPropagation()
    })
}), $(".numberInput").bind("change keyup input click", function() {
    this.value.match(/[^0-9]/g) && (this.value = this.value.replace(/[^0-9]/g, ""))
});